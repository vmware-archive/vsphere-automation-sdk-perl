...
########################################################################
## @file StringType.pm
# The file implements String Type in Perl Binding.
#

package Com::Vmware::Vapi::Bindings::Type::StringType;

## @class StringType
# Representation of String Type in Perl Binding
#
# @par Assumptions:
# None.
#
...
## @method new
# Constructor to initialize the string type object
#
# @param
# None.
#
