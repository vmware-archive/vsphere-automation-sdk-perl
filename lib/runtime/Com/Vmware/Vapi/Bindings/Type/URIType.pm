...
########################################################################
## @file UriType.pm
# The file implements Uri Type in Perl Binding.
#

package Com::Vmware::Vapi::Bindings::Type::URIType;

## @class UriType
# Representation of Uri Type in Perl Binding
#
# @par Assumptions:
# None.
#
...
## @method new
# Constructor to initialize the Uri type object
#
# @param
# None.
#
