...
########################################################################
## @file BinaryType.pm
# The file implements Binary Type in Perl Binding.
#

package Com::Vmware::Vapi::Bindings::Type::BinaryType;

## @class BinaryType
# Representation of Binary Type in Perl Binding
#
# @par Assumptions:
# None.
#
...
## @method new
# Constructor to initialize the Binary type object
#
# @param
# None.
#
