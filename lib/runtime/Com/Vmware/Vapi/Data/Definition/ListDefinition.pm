package Com::Vmware::Vapi::Data::Definition::ListDefinition;
...
sub new
{
   ...
   my $self = $class->SUPER::new(type => Com::Vmware::Vapi::Data::Type::LIST);
   bless $self, $class;
   return ($self);
}
...
sub new_value {
   my ($self, %args) = @_;
   my $value = $args {value};
   return new Com::Vmware::Vapi::Data::Value::ListValue (value => $value);
}
