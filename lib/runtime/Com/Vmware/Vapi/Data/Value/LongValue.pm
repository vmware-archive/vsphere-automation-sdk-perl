...
package Com::Vmware::Vapi::Data::Value::LongValue;
...
# @method new
# Constructor to initialize the LongValue object
#
...
sub new
{
   ...
   my $self = $class->SUPER::new (data_type => Com::Vmware::Vapi::Data::Type->LONG);
