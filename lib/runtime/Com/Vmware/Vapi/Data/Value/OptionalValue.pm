...
########################################################################
## @file OptionalValue.pm
# DataValue class for optionals.
#

package Com::Vmware::Vapi::Data::Value::OptionalValue;
...
# @method new
# Constructor to initialize the OptionalValue object
#
...
sub new
{
   ...
   my $self = $class->SUPER::new (data_type => Com::Vmware::Vapi::Data::Type->OPTIONAL);
