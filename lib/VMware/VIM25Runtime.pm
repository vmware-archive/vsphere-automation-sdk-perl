...
##################################################################################
package SiteInfoManager;
our @ISA = qw(ViewBase SiteInfoManagerOperations);

VIMRuntime::make_get_set('SiteInfoManager');
...
##################################################################################
package TenantTenantManager;
our @ISA = qw(ViewBase TenantTenantManagerOperations);

VIMRuntime::make_get_set('TenantTenantManager');
...
##################################################################################
package SiteInfoManagerOperations;
sub GetSiteInfo {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('GetSiteInfo', %args));
   return $response
}
...
##################################################################################
package TenantTenantManagerOperations;
sub MarkServiceProviderEntities {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('MarkServiceProviderEntities', %args));
   return $response
}

sub UnmarkServiceProviderEntities {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnmarkServiceProviderEntities', %args));
   return $response
}

sub RetrieveServiceProviderEntities {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveServiceProviderEntities', %args));
   return $response
}
