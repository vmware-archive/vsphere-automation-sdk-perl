...
package Com::Vmware::Appliance::Local_accounts::PolicyStub;

## @class Com::Vmware::Appliance::Local_accounts::Policy
#
#The {@name Policy} {@term service} provides {@term operations} to manage
#local user accounts
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'policy' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Local_accounts', 'type_name' => 'Policy::Info'),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Local_accounts', 'type_name' => 'Policy::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.local_accounts.policy',
