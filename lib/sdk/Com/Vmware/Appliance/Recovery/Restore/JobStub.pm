...
package Com::Vmware::Appliance::Recovery::Restore::JobStub;
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'piece' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Restore', 'type_name' => 'Job::RestoreRequest'),
      }
   );
   ...
   my $operations = {
      'cancel' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Restore', 'type_name' => 'Job::ReturnResult'),
      ...
      'create' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Restore', 'type_name' => 'Job::RestoreJobStatus'),
