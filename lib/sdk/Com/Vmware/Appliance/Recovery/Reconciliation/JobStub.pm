...
package Com::Vmware::Appliance::Recovery::Reconciliation::JobStub;

## @class Com::Vmware::Appliance::Recovery::Reconciliation::Job
#
#The {@name Job} {@term service} provides {@term operations}
#to create and get the status of reconciliation job.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Reconciliation', 'type_name' => 'Job::CreateSpec'),
      }
   );
   ...
   my $operations = {
      'create' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Reconciliation', 'type_name' => 'Job::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.recovery.reconciliation.job',
