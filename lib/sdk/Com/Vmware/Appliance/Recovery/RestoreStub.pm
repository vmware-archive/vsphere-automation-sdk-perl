...
package Com::Vmware::Appliance::Recovery::RestoreStub;

## @class Com::Vmware::Appliance::Recovery::Restore
#
#{@name Restore} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $validate_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'piece' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery', 'type_name' => 'Restore::RestoreRequest'),
      }
   );
   ...
   my $operations = {
      'validate' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery', 'type_name' => 'Restore::Metadata'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.recovery.restore',
