...
package Com::Vmware::Appliance::Recovery::Backup::SystemNameStub;

## @class Com::Vmware::Appliance::Recovery::Backup::SystemName
#
#The {@name SystemName} {@term service} provides {@term operations}
#to enumerate system names of appliance backups.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'loc_spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Backup', 'type_name' => 'LocationSpec'),
      }
   );
   my $list_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.recovery.backup.system_name',
