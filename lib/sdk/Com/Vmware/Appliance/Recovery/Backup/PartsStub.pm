...
package Com::Vmware::Appliance::Recovery::Backup::PartsStub;

## @class Com::Vmware::Appliance::Recovery::Backup::Parts
#
#{@name Parts} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Backup', 'type_name' => 'Parts::Part')),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::LongType(),
