...
package Com::Vmware::Appliance::Recovery::Backup::Job::DetailsStub;

## @class Com::Vmware::Appliance::Recovery::Backup::Job::Details
#
#The {@name Details} {@term service} provides {@term operations}
#to get the details about backup jobs.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Recovery::Backup::Job', 'type_name' => 'Details::FilterSpec')),
      }
   );
   my $list_error_dict = {
