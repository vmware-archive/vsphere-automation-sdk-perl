...
package Com::Vmware::Appliance::System::Time::TimezoneStub;

## @class Com::Vmware::Appliance::System::Time::Timezone
#
#The {@name Timezone} {@term service} provides {@term operations}
#to get and set the appliance timezone.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.system.time.timezone',
