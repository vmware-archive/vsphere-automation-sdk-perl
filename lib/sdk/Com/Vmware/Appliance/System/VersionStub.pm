...
package Com::Vmware::Appliance::System::VersionStub;

## @class Com::Vmware::Appliance::System::Version
#
#{@name Version} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::System', 'type_name' => 'Version::VersionStruct'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.system.version',
