...
package Com::Vmware::Appliance::System::TimeStub;

## @class Com::Vmware::Appliance::System::Time
#
#{@name Time} {@term service} provides {@term operations}
#Gets system time.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::System', 'type_name' => 'Time::SystemTimeStruct'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.system.time',
