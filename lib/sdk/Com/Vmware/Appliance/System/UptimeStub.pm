...
package Com::Vmware::Appliance::System::UptimeStub;

## @class Com::Vmware::Appliance::System::Uptime
#
#{@name Uptime} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::DoubleType(),
