...
package Com::Vmware::Appliance::Access::ConsolecliStub;

## @class Com::Vmware::Appliance::Access::Consolecli
#
#{@name Consolecli} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'enabled' => new Com::Vmware::Vapi::Bindings::Type::BooleanType(),
      }
   );
   my $set_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.access.consolecli',
