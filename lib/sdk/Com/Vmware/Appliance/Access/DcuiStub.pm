...
package Com::Vmware::Appliance::Access::DcuiStub;

## @class Com::Vmware::Appliance::Access::Dcui
#
#{@name Dcui} {@term service} provides {@term operations}
#Get/Set enabled state of DCUI.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.access.dcui',
