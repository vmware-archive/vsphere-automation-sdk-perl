## @class Com::Vmware::Appliance::Infraprofile::TaskInfo
#
#


package Com::Vmware::Appliance::Infraprofile::TaskInfo;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Appliance::Infraprofile::TaskInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Appliance::Infraprofile::TaskInfo');
   $self->set_binding_name('name' => 'com.vmware.appliance.infraprofile.task_info');
