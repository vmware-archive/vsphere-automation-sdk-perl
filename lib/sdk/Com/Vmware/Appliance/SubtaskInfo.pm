## @class Com::Vmware::Appliance::SubtaskInfo
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Appliance::SubtaskInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Appliance::SubtaskInfo');
   $self->set_binding_name('name' => 'com.vmware.appliance.subtask_info');
   ...
   $self->set_binding_field('key' => 'result', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'Notifications')));
