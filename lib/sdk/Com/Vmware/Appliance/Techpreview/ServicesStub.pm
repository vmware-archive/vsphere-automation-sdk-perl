...
package Com::Vmware::Appliance::Techpreview::ServicesStub;

## @class Com::Vmware::Appliance::Techpreview::Services
#
#{@name Services} {@term service} provides {@term operations}
#Manages services.
#
...
sub new
{
   ...
   #
   my $control_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'args' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StringType()),
                   'name' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'timeout' => new Com::Vmware::Vapi::Bindings::Type::LongType(),
      }
   );
   my $control_error_dict = {
   ...
   my $control_input_validator_list = [
   ];
   my $control_output_validator_list = [];
   ...
   my $operations = {
      ...
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview', 'type_name' => 'Services::ServiceInfo')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.techpreview.services',
