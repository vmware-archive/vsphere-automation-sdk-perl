...
package Com::Vmware::Appliance::Techpreview::TimesyncStub;

## @class Com::Vmware::Appliance::Techpreview::Timesync
#
#{@name Timesync} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview', 'type_name' => 'Timesync::TimeSyncConfig'),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview', 'type_name' => 'Timesync::TimeSyncConfig'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.techpreview.timesync',
