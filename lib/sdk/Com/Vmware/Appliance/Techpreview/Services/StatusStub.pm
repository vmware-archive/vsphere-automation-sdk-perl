...
package Com::Vmware::Appliance::Techpreview::Services::StatusStub;

## @class Com::Vmware::Appliance::Techpreview::Services::Status
#
#{@name Status} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview::Services', 'type_name' => 'Status::ServiceStatus'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.techpreview.services.status',
