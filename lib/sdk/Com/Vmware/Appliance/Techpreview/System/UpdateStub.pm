...
package Com::Vmware::Appliance::Techpreview::System::UpdateStub;

## @class Com::Vmware::Appliance::Techpreview::System::Update
#
#{@name Update} {@term service} provides {@term operations}
#Performs update repository configuration.
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview::System', 'type_name' => 'Update::UpdateStructSet'),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview::System', 'type_name' => 'Update::UpdateStructGet'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.techpreview.system.update',
