...
package Com::Vmware::Appliance::Techpreview::NtpStub;

## @class Com::Vmware::Appliance::Techpreview::Ntp
#
#{@name Ntp} {@term service} provides {@term operations}
#Gets NTP configuration status and tests connection to ntp servers.
#
...
sub new
{
   ...
   my $operations = {
      'test' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview', 'type_name' => 'Ntp::TestStatusInfo'),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Techpreview', 'type_name' => 'Ntp::NTPConfig'),
