...
package Com::Vmware::Appliance::Update::StagedStub;

## @class Com::Vmware::Appliance::Update::Staged
#
#The {@name Staged} {@term service} provides {@term operations}
#to get the status of the staged update.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Update', 'type_name' => 'Staged::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.update.staged',
