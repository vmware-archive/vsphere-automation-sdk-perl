...
package Com::Vmware::Appliance::Networking::Dns::HostnameStub;

## @class Com::Vmware::Appliance::Networking::Dns::Hostname
#
#{@name Hostname} {@term service} provides {@term operations}
#Performs operations on Fully Qualified Doman Name.
#
...
sub new
{
   ...
   my $operations = {
      'test' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Dns', 'type_name' => 'Hostname::TestStatusInfo'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.networking.dns.hostname',
