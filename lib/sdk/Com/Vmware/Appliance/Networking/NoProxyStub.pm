...
package Com::Vmware::Appliance::Networking::NoProxyStub;

## @class Com::Vmware::Appliance::Networking::NoProxy
#
#The {@name NoProxy} {@term service} provides {@term operations}
#to configure a connection that does not need a proxy.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.networking.no_proxy',
