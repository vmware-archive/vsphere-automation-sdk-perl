...
package Com::Vmware::Appliance::Networking::Interfaces::Ipv6Stub;

## @class Com::Vmware::Appliance::Networking::Interfaces::Ipv6
#
#The {@name Ipv6} {@term service} provides {@term operations}
#to perform IPv6 network configuration for interfaces.
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'interface_name' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Interfaces', 'type_name' => 'Ipv6::Config'),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Interfaces', 'type_name' => 'Ipv6::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.networking.interfaces.ipv6',
