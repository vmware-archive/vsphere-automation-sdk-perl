...
package Com::Vmware::Appliance::Networking::Interfaces::Ipv4Stub;

## @class Com::Vmware::Appliance::Networking::Interfaces::Ipv4
#
#The {@name Ipv4} {@term service} provides {@term operations}
#to perform IPv4 network configuration for interfaces.
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Interfaces', 'type_name' => 'Ipv4::Config'),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Interfaces', 'type_name' => 'Ipv4::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.networking.interfaces.ipv4',
