...
package Com::Vmware::Appliance::Networking::Firewall::InboundStub;

## @class Com::Vmware::Appliance::Networking::Firewall::Inbound
#
#The {@name Inbound} {@term service} provides {@term operations}
#to manage inbound firewall rules.
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'rules' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Firewall', 'type_name' => 'Inbound::Rule')),
      }
   );
   my $set_error_dict = {
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Networking::Firewall', 'type_name' => 'Inbound::Rule')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.networking.firewall.inbound',
