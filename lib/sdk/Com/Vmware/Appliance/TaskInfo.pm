## @class Com::Vmware::Appliance::TaskInfo
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Appliance::TaskInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Appliance::TaskInfo');
   $self->set_binding_name('name' => 'com.vmware.appliance.task_info');
   ...
   $self->set_binding_field('key' => 'subtask_order', 'value' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StringType()));
   $self->set_binding_field('key' => 'subtasks', 'value' => new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::StringType(), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'SubtaskInfo')}))));
