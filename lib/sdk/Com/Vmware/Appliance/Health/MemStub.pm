...
package Com::Vmware::Appliance::Health::MemStub;

## @class Com::Vmware::Appliance::Health::Mem
#
#{@name Mem} {@term service} provides {@term operations}
#Get memory health.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Health', 'type_name' => 'Mem::HealthLevel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health.mem',
