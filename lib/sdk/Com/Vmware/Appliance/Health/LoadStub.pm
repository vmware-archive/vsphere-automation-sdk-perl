...
package Com::Vmware::Appliance::Health::LoadStub;

## @class Com::Vmware::Appliance::Health::Load
#
#{@name Load} {@term service} provides {@term operations}
#Get load health.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Health', 'type_name' => 'Load::HealthLevel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health.load',
