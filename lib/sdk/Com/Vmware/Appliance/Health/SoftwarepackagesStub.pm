...
package Com::Vmware::Appliance::Health::SoftwarepackagesStub;

## @class Com::Vmware::Appliance::Health::Softwarepackages
#
#{@name Softwarepackages} {@term service} provides {@term operations}
#Get information on available software updates available
#in remote VUM repository.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Health', 'type_name' => 'Softwarepackages::HealthLevel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health.softwarepackages',
