...
package Com::Vmware::Appliance::Health::DatabasestorageStub;

## @class Com::Vmware::Appliance::Health::Databasestorage
#
#{@name Databasestorage} {@term service} provides {@term operations}
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Health', 'type_name' => 'Databasestorage::HealthLevel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health.databasestorage',
