...
package Com::Vmware::Appliance::Health::SwapStub;

## @class Com::Vmware::Appliance::Health::Swap
#
#{@name Swap} {@term service} provides {@term operations}
#Get swap health.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance::Health', 'type_name' => 'Swap::HealthLevel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health.swap',
