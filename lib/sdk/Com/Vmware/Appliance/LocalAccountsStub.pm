...
package Com::Vmware::Appliance::LocalAccountsStub;

## @class Com::Vmware::Appliance::LocalAccounts
#
#The {@name LocalAccounts} {@term service} provides {@term operations}
#to manage local user account.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'username' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'LocalAccounts::Config'),
      }
   );
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'username' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'config' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'LocalAccounts::UpdateConfig'),
      }
   );
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'LocalAccounts::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.local_accounts',
