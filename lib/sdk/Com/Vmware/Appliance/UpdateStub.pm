...
package Com::Vmware::Appliance::UpdateStub;

## @class Com::Vmware::Appliance::Update
#
#The {@name Update} {@term service} provides {@term operations}
#to get the status of the appliance update.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'Update::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.update',
