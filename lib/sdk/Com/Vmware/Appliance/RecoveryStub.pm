...
package Com::Vmware::Appliance::RecoveryStub;

## @class Com::Vmware::Appliance::Recovery
#
#The {@name Recovery} {@term service} provides {@term operations}
#to invoke an appliance recovery (backup and restore).
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'Recovery::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.recovery',
