...
package Com::Vmware::Appliance::ShutdownStub;

## @class Com::Vmware::Appliance::Shutdown
#
#{@name Shutdown} {@term service} provides {@term operations}
#Performs reboot/shutdown operations on appliance.
#
...
sub new
{
   ...
   my $poweroff_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'delay' => new Com::Vmware::Vapi::Bindings::Type::LongType(),
                   'reason' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'Shutdown::ShutdownConfig'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.shutdown',
