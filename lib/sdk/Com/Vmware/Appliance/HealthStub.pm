...
sub new
{
   ...
   #
   my $messages_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'item' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $messages_error_dict = {
   ...
   my $messages_input_validator_list = [
   ];
   my $messages_output_validator_list = [];
   ...
   my $operations = {
      'messages' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Appliance', 'type_name' => 'Notification')),
                'errors'=> $messages_error_dict,
                'input_validator_list'=> $messages_input_validator_list,
                'output_validator_list'=> $messages_output_validator_list,
            },
   };

   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.appliance.health',
