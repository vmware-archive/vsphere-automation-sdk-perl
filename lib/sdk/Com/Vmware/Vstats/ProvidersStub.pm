...
package Com::Vmware::Vstats::ProvidersStub;

## @class Com::Vmware::Vstats::Providers
#
#The {@name Providers} {@term service} manages list of statistical data
#provider services that are currently used.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vstats', 'type_name' => 'Providers::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vstats.providers',
