...
## @file ResourceAddressSchemasStub.pm
...
package Com::Vmware::Vstats::ResourceAddressSchemasStub;

## @class Com::Vmware::Vstats::ResourceAddressSchemas
#
#The {@name ResourceAddressSchemas} {@term service} manages inventory of
#resource addressing schemas used by {@link Counters}. Each schema consists of
#a named list of resource identifiers of specific resource type.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vstats', 'type_name' => 'ResourceAddressSchemas::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vstats.resource_address_schemas',
