...
package Com::Vmware::Vstats::DataStub;

## @class Com::Vmware::Vstats::Data
#
#The {@name Data} {@term service} provides {@term operations} to query
#measurement and statistic data.
#
...
sub new
{
   ...
   #
   my $query_data_points_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vstats', 'type_name' => 'Data::FilterSpec')),
      }
   );
   my $query_data_points_error_dict = {
   ...
   my $query_data_points_input_validator_list = [
   ];
   my $query_data_points_output_validator_list = [];
   ...
   my $operations = {
      'query_data_points' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vstats', 'type_name' => 'Data::DataPointsResult'),
                'errors'=> $query_data_points_error_dict,
                'input_validator_list'=> $query_data_points_input_validator_list,
                'output_validator_list'=> $query_data_points_output_validator_list,
            },
   };

   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vstats.data',
