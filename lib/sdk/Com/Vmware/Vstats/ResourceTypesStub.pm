...
package Com::Vmware::Vstats::ResourceTypesStub;

## @class Com::Vmware::Vstats::ResourceTypes
#
#The {@name ResourceTypes} {@term service} provides list of resource types.
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vstats', 'type_name' => 'ResourceTypes::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vstats.resource_types',
