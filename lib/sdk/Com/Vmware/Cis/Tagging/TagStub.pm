...
package Com::Vmware::Cis::Tagging::TagStub;

## @class Com::Vmware::Cis::Tagging::Tag
#
#The {@name Tag} {@term service} provides {@term operations} to create,
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'create_spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Cis::Tagging', 'type_name' => 'Tag::CreateSpec'),
      }
   );
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'tag_id' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'update_spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Cis::Tagging', 'type_name' => 'Tag::UpdateSpec'),
      }
   );
   ...
   #
   my $list_used_tags_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'used_by_entity' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $list_used_tags_error_dict = {};

   my $list_used_tags_input_validator_list = [
   ];
   my $list_used_tags_output_validator_list = [];

   #
   # properties for list_tags_for_category operation
   #
   my $list_tags_for_category_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'category_id' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $list_tags_for_category_error_dict = {
      'com.vmware.vapi.std.errors.not_found' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'NotFound'),
      'com.vmware.vapi.std.errors.unauthorized' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthorized'),

      };

   my $list_tags_for_category_input_validator_list = [
   ];
   my $list_tags_for_category_output_validator_list = [];
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Cis::Tagging', 'type_name' => 'TagModel'),
      ...
      'list_used_tags' => {
                ...
                'input_validator_list'=> $list_used_tags_input_validator_list,
      ...
      'list_tags_for_category' => {
                ...
                'input_validator_list'=> $list_tags_for_category_input_validator_list,
