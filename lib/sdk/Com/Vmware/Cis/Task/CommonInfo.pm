## @class Com::Vmware::Cis::Task::CommonInfo
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Cis::Task::CommonInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Cis::Task::CommonInfo');
   $self->set_binding_name('name' => 'com.vmware.cis.task.common_info');
