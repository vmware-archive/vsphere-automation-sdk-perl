...
package Com::Vmware::Esx::Hcl::ReportsStub;

## @class Com::Vmware::Esx::Hcl::Reports
#
#This {@term service} provides {@term operations} to download information
#generated from the hardware compatibility feature residing on the vCenter
#Appliance.
#
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'report' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $get_error_dict = {
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Hcl', 'type_name' => 'Reports::Location'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.hcl.reports',
