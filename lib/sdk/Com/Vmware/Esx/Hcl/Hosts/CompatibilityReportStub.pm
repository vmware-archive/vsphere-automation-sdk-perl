...
## @file CompatibilityReportStub.pm
...
package Com::Vmware::Esx::Hcl::Hosts::CompatibilityReportStub;

## @class Com::Vmware::Esx::Hcl::Hosts::CompatibilityReport
#
#This {@term service} provides {@term operations} to generate hardware
#compatibility report for a given ESXi host against a specific ESXi release.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Hcl::Hosts', 'type_name' => 'CompatibilityReport::Spec')),
      }
   );
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Hcl::Hosts', 'type_name' => 'CompatibilityReport::Result'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.hcl.hosts.compatibility_report',
