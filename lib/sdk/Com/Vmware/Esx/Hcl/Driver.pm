## @class Com::Vmware::Esx::Hcl::Driver
#
#
# The  ``Com::Vmware::Esx::Hcl::Driver``   *class*  contains  *fields*  describing
#     information about a driver.

package Com::Vmware::Esx::Hcl::Driver;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Hcl::Driver structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Hcl::Driver');
   $self->set_binding_name('name' => 'com.vmware.esx.hcl.driver');
