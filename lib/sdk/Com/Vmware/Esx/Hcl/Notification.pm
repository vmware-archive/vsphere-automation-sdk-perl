## @class Com::Vmware::Esx::Hcl::Notification
#
#
# The  ``Com::Vmware::Esx::Hcl::Notification``   *class*  contains  *fields*  to
#     describe any info/warning/error messages that Tasks can raise.

package Com::Vmware::Esx::Hcl::Notification;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Hcl::Notification structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Hcl::Notification');
   $self->set_binding_name('name' => 'com.vmware.esx.hcl.notification');
