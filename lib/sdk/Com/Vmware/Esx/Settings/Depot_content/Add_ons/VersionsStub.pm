...
package Com::Vmware::Esx::Settings::Depot_content::Add_ons::VersionsStub;

## @class Com::Vmware::Esx::Settings::Depot_content::Add_ons::Versions
#
#The {@name Versions} {@term service} provides {@term operations}
#to get OEM add-on versions from the sync'ed and imported depots.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depot_content::Add_ons', 'type_name' => 'Versions::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.depot_content.add_ons.versions',
