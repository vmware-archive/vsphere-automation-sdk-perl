...
package Com::Vmware::Esx::Settings::Depot_content::Base_images::VersionsStub;

## @class Com::Vmware::Esx::Settings::Depot_content::Base_images::Versions
#
#The {@name Versions} {@term service} provides {@term operations}
#to get versions of base-images from the sync'ed and imported depots.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depot_content::Base_images', 'type_name' => 'Versions::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.depot_content.base_images.versions',
