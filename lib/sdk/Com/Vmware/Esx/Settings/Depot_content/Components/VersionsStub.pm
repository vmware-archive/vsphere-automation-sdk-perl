...
package Com::Vmware::Esx::Settings::Depot_content::Components::VersionsStub;

## @class Com::Vmware::Esx::Settings::Depot_content::Components::Versions
#
#The {@name Versions} {@term service} provides {@term operations}
#to get component versions from the sync'ed and imported depots.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depot_content::Components', 'type_name' => 'Versions::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.depot_content.components.versions',
