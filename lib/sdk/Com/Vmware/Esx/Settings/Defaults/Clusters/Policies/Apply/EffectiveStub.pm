...
package Com::Vmware::Esx::Settings::Defaults::Clusters::Policies::Apply::EffectiveStub;
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Defaults::Clusters::Policies::Apply', 'type_name' => 'Effective::EffectivePolicySpec'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.defaults.clusters.policies.apply.effective',
