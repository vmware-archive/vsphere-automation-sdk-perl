...
package Com::Vmware::Esx::Settings::Clusters::Software::ComplianceStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Compliance
#
#The {@name Compliance} {@term service} provides {@term operations} to get
#the last software compliance result for an ESX cluster.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings', 'type_name' => 'ClusterCompliance'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.compliance',
