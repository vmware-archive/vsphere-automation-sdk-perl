...
package Com::Vmware::Esx::Settings::Clusters::Software::Reports::LastApplyResultStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Reports::LastApplyResult
#
#The {@name LastApplyResult} {@term service} provides {@term operations} to
#get the most recent available result of applying the desired software
#document to all hosts within a cluster.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Reports', 'type_name' => 'LastApplyResult::ApplyResult'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.reports.last_apply_result',
