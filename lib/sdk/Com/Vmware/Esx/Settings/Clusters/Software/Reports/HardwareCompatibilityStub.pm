...
## @file HardwareCompatibilityStub.pm
...
package Com::Vmware::Esx::Settings::Clusters::Software::Reports::HardwareCompatibilityStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Reports::HardwareCompatibility
#
#The {@name HardwareCompatibility} {@term service} provides {@term operations}
#to manage HCL Validation of a software specification of an ESX cluster.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Reports', 'type_name' => 'HardwareCompatibility::CheckSummary'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.reports.hardware_compatibility',
