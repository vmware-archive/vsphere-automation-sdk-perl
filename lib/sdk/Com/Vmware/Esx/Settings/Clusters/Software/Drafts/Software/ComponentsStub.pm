...
package Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::ComponentsStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::Components
#
#The {@name Components} {@term service} provides {@term operations} to manage
#component specification in a software draft.
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'draft' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'component' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'version' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::StringType()),
      }
   );
   my $set_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'draft' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software', 'type_name' => 'Components::UpdateSpec'),
      }
   );
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.drafts.software.components',
