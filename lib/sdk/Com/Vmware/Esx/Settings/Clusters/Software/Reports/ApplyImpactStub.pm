...
package Com::Vmware::Esx::Settings::Clusters::Software::Reports::ApplyImpactStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Reports::ApplyImpact
#
#The {@name ApplyImpact} {@term service} provides {@term operations} to get
#the impact of an apply {@term operation} on a cluster.
#
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Reports', 'type_name' => 'ApplyImpact::ApplyImpactSpec')),
      }
   );
   my $get_error_dict = {
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Reports', 'type_name' => 'ApplyImpact::ClusterImpact'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.reports.apply_impact',
