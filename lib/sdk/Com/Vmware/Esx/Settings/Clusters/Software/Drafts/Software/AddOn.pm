...
## @class Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn
# The  ``Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn``  
#     *interface*  provides  *methods*  to manage the OEM add-on specification in a software
#     draft.
#
#
...
package Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn;
...
use Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOnStub;
...
#
use constant _VAPI_SERVICE_ID => 'com.vmware.esx.settings.clusters.software.drafts.software.add_on';
...
#     ``draft``  in the system or no add-on specification is set.
#
...
## @method set ()
# Sets a new desired OEM add-on specification in the software draft. It will overwrite the
# existing desired OEM add-on specification if one already exists.
#
# Note:
...
# . The value must be str.
#
# @param spec [REQUIRED] AddOn specification.
# . The value must be Com::Vmware::Esx::Settings::AddOnSpec.
#
# @throw Com::Vmware::Vapi::Std::Errors::Error 
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn service
#########################################################################################


#########################################################################################
# Ends structures for the Com::Vmware::Esx::Settings::Clusters::Software::Drafts::Software::AddOn service
#########################################################################################
