...
package Com::Vmware::Esx::Settings::Clusters::Software::Reports::Hardware_compatibility::DetailsStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Reports::Hardware_compatibility::Details
#
#The {@name ComplianceStatus} {@term structure} contains the possible
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software::Reports', 'type_name' => 'CheckResult'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.reports.hardware_compatibility.details',
