...
package Com::Vmware::Esx::Settings::Clusters::Software::EffectiveComponentsStub;
...
#to get effective list of components.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.effective_components',
