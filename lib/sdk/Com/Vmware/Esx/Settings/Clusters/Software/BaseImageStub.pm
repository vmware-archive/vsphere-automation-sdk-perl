...
package Com::Vmware::Esx::Settings::Clusters::Software::BaseImageStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::BaseImage
#
#The {@name BaseImage} {@term service} provides {@term operations} to manage
#desired ESX base image.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.base_image',
