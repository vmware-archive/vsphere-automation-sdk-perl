...
package Com::Vmware::Esx::Settings::Clusters::Software::CommitsStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Commits
#
#The {@name Commits} {@term service} provides {@term operations}
#to manage committed changes to desired software document.
#
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'commit' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $get_error_dict = {
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software', 'type_name' => 'Commits::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.commits',
