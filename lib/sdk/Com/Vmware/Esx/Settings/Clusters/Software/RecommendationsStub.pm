...
package Com::Vmware::Esx::Settings::Clusters::Software::RecommendationsStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software::Recommendations
#
#The {@name Recommendations} {@term service} provides {@term operations}
#to manage the generation and retrieval of recommended image specs.
#
...
sub new
{
   ...
   #
   my $generate_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $generate_error_dict = {
      ...
      'com.vmware.vapi.std.errors.concurrent_change' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'ConcurrentChange'),
   ...
   my $generate_input_validator_list = [
   ];
   my $generate_output_validator_list = [];
   ...
   my $operations = {
      'generate$task' => {
                ...
                'input_validator_list'=> $generate_input_validator_list,
                'output_validator_list'=> $generate_output_validator_list,
            },
      'get' => {
                'input_type'=> $get_input_type,
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Software', 'type_name' => 'Recommendations::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software.recommendations',
