...
package Com::Vmware::Esx::Settings::Clusters::SoftwareStub;

## @class Com::Vmware::Esx::Settings::Clusters::Software
#
#The {@name Software} {@term service} provides {@term operations} to manage
#desired software specification of an ESX cluster.
#
...
sub new
{
   ...
   my $export_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'Software::ExportSpec'),
      }
   );
   ...
   #
   my $apply_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'Software::ApplySpec'),
      }
   );
   my $apply_error_dict = {
   ...
   my $apply_input_validator_list = [
   ];
   my $apply_output_validator_list = [];
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'Software::CheckSpec'),
      }
   );
   my $check_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings', 'type_name' => 'SoftwareInfo'),
      ...
      'export' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'Software::ExportType'), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::URIType()}))),
      ...
      'apply$task' => {
                ...
                'input_validator_list'=> $apply_input_validator_list,
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.software',
