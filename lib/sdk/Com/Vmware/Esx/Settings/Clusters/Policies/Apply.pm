...
# The  ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply``   *interface*  provides
#     *methods*  to configure the policies that will impact how the software and
...
use Com::Vmware::Esx::Settings::Clusters::Policies::ApplyStub;
...
#
use constant _VAPI_SERVICE_ID => 'com.vmware.esx.settings.clusters.policies.apply';
...
# Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec
#
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply service
#########################################################################################

## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction
#
#
# The  ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction``  
...
package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction');
   $self->set_binding_name('name' => 'com.vmware.esx.settings.clusters.policies.apply.failure_action');
   $self->set_binding_field('key' => 'action', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies', 'type_name' => 'Apply::FailureAction::Action'));
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action
#
# The  ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action`` 
#     *enumerated type*  defines the actions to be taken when entering maintenance mode
#     fails on a single host within the cluster.
#
#
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action::FAIL #
#Fail the apply  *method* 
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action::RETRY #
#Retry the task 
# :attr:`Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction.retry_count` 
# number of times on the failed host after 
# :attr:`Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction.retry_delay` .

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.esx.settings.clusters.policies.apply.failure_action.action',
                           'binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::FailureAction::Action');
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec
#
#
# The  ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec``  
#     *class*  contains  *fields*  that describe the policies configured to be used when the
#     software and configuration specification documents are applied to an ESXi cluster.

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_field('key' => 'failure_action', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies', 'type_name' => 'Apply::FailureAction')));
   $self->set_binding_field('key' => 'pre_remediation_power_action', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies', 'type_name' => 'Apply::ConfiguredPolicySpec::PreRemediationPowerAction')));
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction
#
# The 
#     ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction``
#     *enumerated type*  defines the possible actions to be taken, before entering
#     maintenance mode.
#
#
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction::POWER_OFF_VMS #
#Power off VMs before entering maintenance mode.
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction::SUSPEND_VMS #
#Suspend VMs before entering maintenance mode
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction::DO_NOT_CHANGE_VMS_POWER_STATE #
#Do not change the VM power state

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $self = $class->SUPER::new();
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.esx.settings.clusters.policies.apply.configured_policy_spec.pre_remediation_power_action',
                           'binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::ConfiguredPolicySpec::PreRemediationPowerAction');
   $class->SUPER::set_binding_type('binding_type' => $bindingType);
...
#########################################################################################
# Ends structures for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply service
#########################################################################################
