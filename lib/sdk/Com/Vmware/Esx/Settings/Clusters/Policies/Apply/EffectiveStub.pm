...
package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::EffectiveStub;

## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective
#
#The {@name Effective} {@term service} provides {@term operations} to manage
#the effective policies that will impact how the software and configuration
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply', 'type_name' => 'Effective::EffectivePolicySpec'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.policies.apply.effective',
