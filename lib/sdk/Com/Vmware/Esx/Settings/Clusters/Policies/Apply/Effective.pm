...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective
# The  ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective``  
#     *interface*  provides  *methods*  to manage the effective policies that will impact
#     how the software and configuration specification documents are applied to an ESXi
#     cluster.
#

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective;
...
use Com::Vmware::Esx::Settings::Clusters::Policies::Apply::EffectiveStub;
...
#
use constant _VAPI_SERVICE_ID => 'com.vmware.esx.settings.clusters.policies.apply.effective';
...
# Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec
#
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective service
#########################################################################################

## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction
#
#
# The 
#     ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction``  
...
package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction');
   $self->set_binding_name('name' => 'com.vmware.esx.settings.clusters.policies.apply.effective.failure_action');
   $self->set_binding_field('key' => 'action', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply', 'type_name' => 'Effective::FailureAction::Action'));
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action
#
# The 
#     ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action``
#     *enumerated type*  defines the actions to be taken when entering maintenance mode
#     fails on a single host within the cluster.
#
#
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action::FAIL #
#Fail the apply  *method* 
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action::RETRY #
#Retry the task null number of times on the failed host after null.

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.esx.settings.clusters.policies.apply.effective.failure_action.action',
                           'binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::FailureAction::Action');
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec
#
#
# The 
#     ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec``
...
package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_field('key' => 'failure_action', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply', 'type_name' => 'Effective::FailureAction'));
   $self->set_binding_field('key' => 'pre_remediation_power_action', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply', 'type_name' => 'Effective::EffectivePolicySpec::PreRemediationPowerAction'));
...
## @class Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction
#
# The 
#     ``Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction``
#     *enumerated type*  defines the possible actions to be taken, before entering
#     maintenance mode.
#
#
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction::POWER_OFF_VMS #
#Power off VMs before entering maintenance mode.
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction::SUSPEND_VMS #
#Suspend VMs before entering maintenance mode
#
# Constant Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction::DO_NOT_CHANGE_VMS_POWER_STATE #
#Do not change the VM power state

package Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $self = $class->SUPER::new();
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.esx.settings.clusters.policies.apply.effective.effective_policy_spec.pre_remediation_power_action',
                           'binding_class' => 'Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective::EffectivePolicySpec::PreRemediationPowerAction');
   $class->SUPER::set_binding_type('binding_type' => $bindingType);
...
#########################################################################################
# Ends structures for the Com::Vmware::Esx::Settings::Clusters::Policies::Apply::Effective service
#########################################################################################
