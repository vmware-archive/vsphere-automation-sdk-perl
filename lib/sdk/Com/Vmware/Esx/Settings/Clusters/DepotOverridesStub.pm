...
package Com::Vmware::Esx::Settings::Clusters::DepotOverridesStub;

## @class Com::Vmware::Esx::Settings::Clusters::DepotOverrides
#
#The {@name DepotOverrides} {@term service} provides {@term operations} to manage
#software depots overriden for a given cluster. In general ESX servers reach
#out to vCenter (VUM) to fetch the metadata and payloads required for
#lifecycle operations. But in ROBO environments ESX clusters can't (or
#because of bandwidth requirements shouldn't) reach out to vCenter to fetch
#payloads and metadata.
#This {@term service} allows setting cluster level overrides for depots.
#If any depots are provided for a cluster, then vCenter level depots are not
...
sub new
{
   ...
   my $add_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'depot' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'DepotOverrides::Depot'),
      }
   );
   my $add_error_dict = {
      'com.vmware.vapi.std.errors.unauthenticated' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthenticated'),
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Clusters', 'type_name' => 'DepotOverrides::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.clusters.depot_overrides',
