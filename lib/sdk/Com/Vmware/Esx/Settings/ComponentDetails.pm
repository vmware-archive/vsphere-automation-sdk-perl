## @class Com::Vmware::Esx::Settings::ComponentDetails
#
#
# The  ``Com::Vmware::Esx::Settings::ComponentDetails``   *class*  contains information
#     that provide more details about the component from the depot.

package Com::Vmware::Esx::Settings::ComponentDetails;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::ComponentDetails structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Settings::ComponentDetails');
   $self->set_binding_name('name' => 'com.vmware.esx.settings.component_details');
