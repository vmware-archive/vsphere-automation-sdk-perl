...
package Com::Vmware::Esx::Settings::DepotsStub;

## @class Com::Vmware::Esx::Settings::Depots
#
#The {@name Depots} {@term service} provides {@term operations}
#to manage Software Depots used during ESX lifecycle management.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.depots',
