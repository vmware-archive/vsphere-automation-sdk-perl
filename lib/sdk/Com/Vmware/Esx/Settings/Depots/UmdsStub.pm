...
package Com::Vmware::Esx::Settings::Depots::UmdsStub;

## @class Com::Vmware::Esx::Settings::Depots::Umds
#
#The {@name Umds} {@term service} provides {@term operations}
#to manage VMware vSphere Update Manager Download Service (UMDS)
#software depots used during ESX lifecycle management.
#This is the depot downloaded using UMDS.<p>
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depots', 'type_name' => 'Umds::SetSpec'),
      }
   );
   my $set_error_dict = {
      'com.vmware.vapi.std.errors.unauthenticated' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthenticated'),
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depots', 'type_name' => 'Umds::UpdateSpec'),
      }
   );
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings::Depots', 'type_name' => 'Umds::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.esx.settings.depots.umds',
