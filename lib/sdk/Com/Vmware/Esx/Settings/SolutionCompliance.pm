## @class Com::Vmware::Esx::Settings::SolutionCompliance
#
#
# The  ``Com::Vmware::Esx::Settings::SolutionCompliance``   *class*  contains
#     information that describe the compliance result of a host with respect to given
#     solution present in the target software specification.

package Com::Vmware::Esx::Settings::SolutionCompliance;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Settings::SolutionCompliance structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Settings::SolutionCompliance');
   $self->set_binding_name('name' => 'com.vmware.esx.settings.solution_compliance');
   ...
   $self->set_binding_field('key' => 'current', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings', 'type_name' => 'SolutionInfo')));
   $self->set_binding_field('key' => 'target', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Settings', 'type_name' => 'SolutionInfo')));
