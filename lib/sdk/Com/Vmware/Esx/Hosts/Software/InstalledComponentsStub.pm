...
## @file InstalledComponentsStub.pm
...
package Com::Vmware::Esx::Hosts::Software::InstalledComponentsStub;

## @class Com::Vmware::Esx::Hosts::Software::InstalledComponents
#
#The {@name InstalledComponents} {@term service} provides {@term operations}
#to get installed list of components.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::StringType(), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Esx::Hosts::Software', 'type_name' => 'InstalledComponents::InstalledComponentInfo')}))),
