## @class Com::Vmware::Esx::Hosts::ComponentInfo
#
#
# The  ``Com::Vmware::Esx::Hosts::ComponentInfo``   *class*  contains  *fields*  that
#     describe a specific component version in a software specification.

package Com::Vmware::Esx::Hosts::ComponentInfo;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Esx::Hosts::ComponentInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Esx::Hosts::ComponentInfo');
   $self->set_binding_name('name' => 'com.vmware.esx.hosts.component_info');
