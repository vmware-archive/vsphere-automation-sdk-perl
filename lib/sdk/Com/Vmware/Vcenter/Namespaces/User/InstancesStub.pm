...
package Com::Vmware::Vcenter::Namespaces::User::InstancesStub;

## @class Com::Vmware::Vcenter::Namespaces::User::Instances
#
#The {@name Instances} {@term service} provides {@term operations}
#to access namespaces for non-administrative users.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespaces::User', 'type_name' => 'Instances::Summary')),
