...
package Com::Vmware::Vcenter::Lcm::Update::PendingStub;

## @class Com::Vmware::Vcenter::Lcm::Update::Pending
#
#The {@name Pending} {@term service} provides {@term operation} for listing
#pending minor or major updates of vCenter Server.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm::Update', 'type_name' => 'Pending::ListResult'),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm::Update', 'type_name' => 'Pending::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.lcm.update.pending',
