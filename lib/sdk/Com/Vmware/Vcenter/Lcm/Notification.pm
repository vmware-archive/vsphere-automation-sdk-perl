...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Lcm::Notification structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Lcm::Notification');
   $self->set_binding_name('name' => 'com.vmware.vcenter.lcm.notification');
