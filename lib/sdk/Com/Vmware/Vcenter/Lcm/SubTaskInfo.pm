## @class Com::Vmware::Vcenter::Lcm::SubTaskInfo
#
#
# Container that contains the status information about a single task.

package Com::Vmware::Vcenter::Lcm::SubTaskInfo;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Lcm::SubTaskInfo structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->{external_tools} = $args{'external_tools'};
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Lcm::SubTaskInfo');
   $self->set_binding_name('name' => 'com.vmware.vcenter.lcm.sub_task_info');
   $self->set_binding_field('key' => 'progress', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Cis::Task', 'type_name' => 'Progress'));
   $self->set_binding_field('key' => 'last_updated_time', 'value' => new Com::Vmware::Vapi::Bindings::Type::DateTimeType());
   $self->set_binding_field('key' => 'result', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm', 'type_name' => 'Result')));
   $self->set_binding_field('key' => 'external_tools', 'value' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm', 'type_name' => 'ExternalTool')));
...
## @method get_external_tools ()
# Gets the value of 'external_tools' property.
#
# @retval external_tools - The current value of the field.
# External tools used for the deployment.
#
# List#
sub get_external_tools {
   my ($self, %args) = @_;
   return $self->{'external_tools'}; 	
}

## @method set_external_tools ()
# Sets the given value for 'external_tools' property.
# 
# @param external_tools  - New value for the field.
# External tools used for the deployment.
#
sub set_external_tools {
   my ($self, %args) = @_;
   $self->{'external_tools'} = $args{'external_tools'}; 
   return;	
}
