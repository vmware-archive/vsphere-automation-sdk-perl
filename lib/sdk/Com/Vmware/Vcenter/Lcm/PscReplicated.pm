## @class Com::Vmware::Vcenter::Lcm::PscReplicated
#
#
# Configuration of the replicated Single Sign-On for PSC type deployment.

package Com::Vmware::Vcenter::Lcm::PscReplicated;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Lcm::PscReplicated structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Lcm::PscReplicated');
   $self->set_binding_name('name' => 'com.vmware.vcenter.lcm.psc_replicated');
...
# Administrator password of the PSC to be replicated.
#
# Secret#
...
# Domain name of the remote PSC. For example, &apos;vsphere.local&apos;
#
# String#
...
# Site name of the newly deployed PSC.
#
# Optional#
