...
package Com::Vmware::Vcenter::Lcm::ReportsStub;

## @class Com::Vmware::Vcenter::Lcm::Reports
#
#The {@name Report} {@term service} provides an {@term operation} to download the
#report generated by the interop and precheck operations. To download a report,
#you must use the {@name #get} {@term operation}. A {@name Report.Location}
#{@term structure} represents the location of the file which has {@name Report.Token}
#{@term structure} which represents the token ID (@name String) and the expiration
#time of the token {@name Report.Token.expiry} {@term DateTime}.
#{@name Report.Location} {@term structure} also has the URI for the file which
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm', 'type_name' => 'Reports::Location'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.lcm.reports',
