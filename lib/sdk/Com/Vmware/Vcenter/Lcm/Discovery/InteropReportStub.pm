...
package Com::Vmware::Vcenter::Lcm::Discovery::InteropReportStub;

## @class Com::Vmware::Vcenter::Lcm::Discovery::InteropReport
#
#The {@name InteropReport} {@term interface} provides {@term operations}
#to report the interoperability between a vCenter Server release version and
#the other installed VMware products registered
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm::Discovery', 'type_name' => 'InteropReport::Spec')),
      }
   );
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.lcm.discovery.interop_report',
