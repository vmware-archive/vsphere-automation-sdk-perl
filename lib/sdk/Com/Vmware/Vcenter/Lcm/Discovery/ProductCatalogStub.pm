...
package Com::Vmware::Vcenter::Lcm::Discovery::ProductCatalogStub;

## @class Com::Vmware::Vcenter::Lcm::Discovery::ProductCatalog
#
#The {@name ProductCatalog} {@term service} provides information
#which VMware products can be associated with vCenter Server.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Lcm::Discovery', 'type_name' => 'ProductCatalog::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.lcm.discovery.product_catalog',
