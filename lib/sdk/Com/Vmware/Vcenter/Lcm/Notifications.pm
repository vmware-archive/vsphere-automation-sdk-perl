## @class Com::Vmware::Vcenter::Lcm::Notifications
#
#
# The  ``Com::Vmware::Vcenter::Lcm::Notifications``   *class*  contains
#     info/warning/error messages that can be reported be the appliance task.

package Com::Vmware::Vcenter::Lcm::Notifications;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Lcm::Notifications structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Lcm::Notifications');
   $self->set_binding_name('name' => 'com.vmware.vcenter.lcm.notifications');
