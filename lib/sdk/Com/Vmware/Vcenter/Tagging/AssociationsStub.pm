...
package Com::Vmware::Vcenter::Tagging::AssociationsStub;

## @class Com::Vmware::Vcenter::Tagging::Associations
#
#The {@name Associations} {@term service} provides
#{@term operations} to list tag associations.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'iterate' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Tagging', 'type_name' => 'Associations::IterationSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Tagging', 'type_name' => 'Associations::ListResult'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.tagging.associations',
