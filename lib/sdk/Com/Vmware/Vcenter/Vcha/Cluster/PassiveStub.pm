...
package Com::Vmware::Vcenter::Vcha::Cluster::PassiveStub;

## @class Com::Vmware::Vcenter::Vcha::Cluster::Passive
#
#The {@name Passive} {@term service} provides {@term operations} to
#validate a passive's placement configuration and redeploy the passive
...
sub new
{
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Passive::CheckSpec'),
      }
   );
   my $check_error_dict = {
   ...
   my $redeploy_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Passive::RedeploySpec'),
      }
   );
   ...
   my $operations = {
      'check' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Passive::CheckResult'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vcha.cluster.passive',
