...
package Com::Vmware::Vcenter::Vcha::Cluster::ActiveStub;

## @class Com::Vmware::Vcenter::Vcha::Cluster::Active
#
#The {@name Active} {@term service} provides {@term operations} to get
#information related to the active vCenter High Availability (VCHA) node.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Active::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vcha.cluster.active',
