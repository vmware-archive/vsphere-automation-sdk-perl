...
package Com::Vmware::Vcenter::Vcha::Cluster::DeploymentTypeStub;

## @class Com::Vmware::Vcenter::Vcha::Cluster::DeploymentType
#
#The {@term DeploymentType} {@term service} provides {@term operations} to
#get the deployment type of a vCenter High Availability Cluster (VCHA
#Cluster).
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'DeploymentType::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vcha.cluster.deployment_type',
