...
package Com::Vmware::Vcenter::Vcha::Cluster::ModeStub;

## @class Com::Vmware::Vcenter::Vcha::Cluster::Mode
#
#The {@term Mode} {@term service} provides {@term operations} to manage
#the operating mode of a vCenter High Availability Cluster (VCHA Cluster).
#
...
sub new
{
   ...
   my $set_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'mode' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Mode::ClusterMode'),
      }
   );
   my $set_error_dict = {
      'com.vmware.vapi.std.errors.unauthorized' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthorized'),
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha::Cluster', 'type_name' => 'Mode::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vcha.cluster.mode',
