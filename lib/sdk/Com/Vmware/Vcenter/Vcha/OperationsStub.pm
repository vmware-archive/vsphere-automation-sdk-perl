...
package Com::Vmware::Vcenter::Vcha::OperationsStub;

## @class Com::Vmware::Vcenter::Vcha::Operations
#
#The {@name Operations} {@term service} provides {@term operations} to
#figure out the currently active operations and currently disabled operations
#in a vCenter High Availability (VCHA) cluster.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vcha', 'type_name' => 'Operations::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vcha.operations',
