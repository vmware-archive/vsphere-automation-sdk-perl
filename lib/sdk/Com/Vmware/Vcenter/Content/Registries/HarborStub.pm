...
package Com::Vmware::Vcenter::Content::Registries::HarborStub;

## @class Com::Vmware::Vcenter::Content::Registries::Harbor
#
#The {@name Harbor} {@term service} provides {@term operations} to manage
#the lifecycle of an integrated Harbor container registry in vCenter.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Content::Registries', 'type_name' => 'Harbor::CreateSpec'),
      }
   );
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Content::Registries', 'type_name' => 'Harbor::Info'),
      ...
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Content::Registries', 'type_name' => 'Harbor::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.content.registries.harbor',
