...
package Com::Vmware::Vcenter::Inventory::DatastoreStub;

## @class Com::Vmware::Vcenter::Inventory::Datastore
#
#The {@name Datastore} {@term service} provides {@term operations} to retrieve
...
sub new
{
   ...
   my $find_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'datastores' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StringType()),
      }
   );
   my $find_error_dict = {
   ...
   my $operations = {
      'find' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::StringType(), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Inventory', 'type_name' => 'Datastore::Info'))}))),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.inventory.datastore',
