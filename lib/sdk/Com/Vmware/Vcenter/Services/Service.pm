...
use Com::Vmware::Vcenter::Services::ServiceStub;
...
#     getQualifiedName(com.vmware.vcenter.services.Service).
...
#     :attr:`Com::Vmware::Vcenter::Services::Service::StartupType.DISABLED` .
#
...
# The return type will be Com::Vmware::Vcenter::Services::Service::Info
#
# @throw Com::Vmware::Vapi::Std::Errors::NotFound 
# if the service associated with  ``service``  does not exist.
#
...
# . The value must be Com::Vmware::Vcenter::Services::Service::UpdateSpec.
#
# @throw Com::Vmware::Vapi::Std::Errors::NotFound 
# if the service associated with  ``service``  does not exist.
#
...
#     :attr:`Com::Vmware::Vcenter::Services::Service::UpdateSpec.startup_type`   *field*  of
#     ``spec``  to  :attr:`Com::Vmware::Vcenter::Services::Service::StartupType.DISABLED` 
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Vcenter::Services::Service service
#########################################################################################

## @class Com::Vmware::Vcenter::Services::Service::StartupType
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Services::Service::StartupType enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.vcenter.services.service.startup_type',
                           'binding_class' => 'Com::Vmware::Vcenter::Services::Service::StartupType');
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Services::Service::State enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $self = $class->SUPER::new();
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.vcenter.services.service.state',
                           'binding_class' => 'Com::Vmware::Vcenter::Services::Service::State');
   $class->SUPER::set_binding_type('binding_type' => $bindingType);
...
1;
## @class Com::Vmware::Vcenter::Services::Service::Health
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Services::Service::Health enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $self = $class->SUPER::new();
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.vcenter.services.service.health',
                           'binding_class' => 'Com::Vmware::Vcenter::Services::Service::Health');
   $class->SUPER::set_binding_type('binding_type' => $bindingType);
...
#########################################################################################
# Ends enumerations for the Com::Vmware::Vcenter::Services::Service service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Vcenter::Services::Service service
#########################################################################################

## @class Com::Vmware::Vcenter::Services::Service::Info
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Services::Service::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Services::Service::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.services.service.info');
   ...
   $self->set_binding_field('key' => 'startup_type', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Services', 'type_name' => 'Service::StartupType'));
   $self->set_binding_field('key' => 'state', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Services', 'type_name' => 'Service::State'));
   $self->set_binding_field('key' => 'health', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Services', 'type_name' => 'Service::Health')));
...
## @class Com::Vmware::Vcenter::Services::Service::UpdateSpec
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Services::Service::UpdateSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Services::Service::UpdateSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.services.service.update_spec');
   $self->set_binding_field('key' => 'startup_type', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Services', 'type_name' => 'Service::StartupType')));
   bless $self, $class;
   return $self;
}
...
#########################################################################################
# Ends structures for the Com::Vmware::Vcenter::Services::Service service
#########################################################################################
