...
## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation
# The 
...
use Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::AttestationStub;
...
#
use constant _VAPI_SERVICE_ID => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.attestation';
...
# Privileges required for this operation are TrustedAdmin.ReadTrustedHosts, System.View.
#
# @param spec [OPTIONAL] Return details about Attestation Services matching the filter.
...
# . The value must be
# Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::SummaryType
# or None.
#
# @retval 
# List of  class
...
#     :attr:`Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec.hosts`
#      requires  ``System.View`` . </li>
# <li> The resource  ``ClusterComputeResource``  referenced by the  *field*  
#     :attr:`Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec.clusters`
#      requires  ``System.View`` . </li>
# </ul>
#
sub list {
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation service
#########################################################################################
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::SummaryType enumeration.
#
# @retval
# Blessed object
#
sub new {
   ...
   my $bindingType = new Com::Vmware::Vapi::Bindings::Type::EnumType(
                           'name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.attestation.summary_type',
                           'binding_class' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::SummaryType');
...
#########################################################################################
# Ends enumerations for the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation service
#########################################################################################

## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Summary
#
#
# The 
#     ``Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Summary``
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Summary structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Summary');
   $self->set_binding_name('name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.attestation.summary');
   $self->set_binding_field('key' => 'summary_type', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts', 'type_name' => 'Attestation::SummaryType'));
...
## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Info
#
#
# The 
#     ``Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Info``
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.attestation.info');
...
## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec
#
#
# The 
#     ``Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec``
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation::FilterSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.attestation.filter_spec');
...
#########################################################################################
# Ends structures for the Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_hosts::Attestation service
#########################################################################################
