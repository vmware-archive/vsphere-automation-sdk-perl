...
package Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Attestation::Os::Esx::BaseImagesStub;
...
#to manage trusted instances of ESX software on a cluster level.
#
...
sub new
{
   ...
   #
   my $import_from_imgdb_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'imgdb' => new Com::Vmware::Vapi::Bindings::Type::BlobType(),
      }
   );
   my $import_from_imgdb_error_dict = {
   ...
   my $import_from_imgdb_input_validator_list = [
   ];
   my $import_from_imgdb_output_validator_list = [];
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Attestation::Os::Esx', 'type_name' => 'BaseImages::FilterSpec')),
      }
   );
   my $list_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $operations = {
      'import_from_imgdb$task' => {
                ...
                'input_validator_list'=> $import_from_imgdb_input_validator_list,
                'output_validator_list'=> $import_from_imgdb_output_validator_list,
            },
      'list$task' => {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.base_images',
