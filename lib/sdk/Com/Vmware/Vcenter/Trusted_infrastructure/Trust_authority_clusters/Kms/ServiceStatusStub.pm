...
package Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Kms::ServiceStatusStub;

## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Kms::ServiceStatus
#
#The {@name ServiceStatus} {@term service} provides {@term operations}
#to get the Key Provider Service health status.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.service_status',
