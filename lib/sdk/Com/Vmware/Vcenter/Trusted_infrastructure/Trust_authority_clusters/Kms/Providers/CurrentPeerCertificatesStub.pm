...
## @file CurrentPeerCertificatesStub.pm
...
package Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Kms::Providers::CurrentPeerCertificatesStub;
...
#Those are meant for review. Following approval these certificates should be added
#as trusted certificates in the {@link TrustedPeerCertificates} {@term service}
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::Kms::Providers', 'type_name' => 'CurrentPeerCertificates::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.current_peer_certificates',
