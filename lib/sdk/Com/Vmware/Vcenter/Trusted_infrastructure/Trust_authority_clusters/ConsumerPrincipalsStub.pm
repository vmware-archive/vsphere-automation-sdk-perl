...
## @file ConsumerPrincipalsStub.pm
...
package Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::ConsumerPrincipalsStub;

## @class Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters::ConsumerPrincipals
#
#The {@name ConsumerPrincipals} {@term service} configures the token
#policies and STS trust necessary for the workload vCenter to query the
#trusted services for their status.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters', 'type_name' => 'ConsumerPrincipals::CreateSpec'),
      }
   );
   ...
   my $delete_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'profile' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'cluster' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure::Trust_authority_clusters', 'type_name' => 'ConsumerPrincipals::FilterSpec')),
      }
   );
   my $list_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.consumer_principals',
