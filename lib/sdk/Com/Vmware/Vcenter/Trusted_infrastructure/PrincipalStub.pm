...
package Com::Vmware::Vcenter::Trusted_infrastructure::PrincipalStub;

## @class Com::Vmware::Vcenter::Trusted_infrastructure::Principal
#
#The {@name Principal} {@term service} contains information about
#the certificates which sign the tokens used by vCenter for authentication.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Trusted_infrastructure', 'type_name' => 'Principal::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.trusted_infrastructure.principal',
