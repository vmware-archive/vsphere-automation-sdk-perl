...
package Com::Vmware::Vcenter::Certificate_management::Vcenter::TlsCsrStub;

## @class Com::Vmware::Vcenter::Certificate_management::Vcenter::TlsCsr
#
#The {@name TlsCsr} {@term interface} provides
#{@term operations} to generate certificate signing request.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'TlsCsr::Spec'),
      }
   );
   ...
   my $operations = {
      'create' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'TlsCsr::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.certificate_management.vcenter.tls_csr',
