...
package Com::Vmware::Vcenter::Certificate_management::Vcenter::TrustedRootChainsStub;

## @class Com::Vmware::Vcenter::Certificate_management::Vcenter::TrustedRootChains
#
#The {@name TrustedRootChains} {@term interface} provides
#{@term operations} to create, modify, delete and read
#trusted root certificate chains.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'TrustedRootChains::CreateSpec'),
      }
   );
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'chain' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $get_error_dict = {
      'com.vmware.vapi.std.errors.unauthorized' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthorized'),
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'TrustedRootChains::Summary')),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'TrustedRootChains::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.certificate_management.vcenter.trusted_root_chains',
