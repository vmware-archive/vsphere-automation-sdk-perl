...
package Com::Vmware::Vcenter::Certificate_management::Vcenter::VmcaRootStub;

## @class Com::Vmware::Vcenter::Certificate_management::Vcenter::VmcaRoot
#
#The {@name VmcaRoot} {@term interface} provides
#{@term operations} to replace VMware Certificate Authority (VMCA) root certificate.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Certificate_management::Vcenter', 'type_name' => 'VmcaRoot::CreateSpec')),
      }
   );
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.certificate_management.vcenter.vmca_root',
