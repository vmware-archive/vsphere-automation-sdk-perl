...
package Com::Vmware::Vcenter::DeploymentStub;

## @class Com::Vmware::Vcenter::Deployment
#
#The {@name Deployment} {@term service} provides {@term operations}
#to get the status of the vCenter appliance deployment.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter', 'type_name' => 'Deployment::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment',
