...
package Com::Vmware::Vcenter::Vm_template::Library_items::CheckOutsStub;

## @class Com::Vmware::Vcenter::Vm_template::Library_items::CheckOuts
#
#The {@name CheckOuts} {@term service} provides {@term operations} for
#managing the checkouts of a library item containing a virtual machine
#template. This {@term service} provides operations to check out a library
#item to update the virtual machine template, and to check in the library
#item when the virtual machine changes are complete.
#
...
sub new
{
   ...
   #
   my $check_out_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'template_library_item' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'CheckOuts::CheckOutSpec')),
      }
   );
   my $check_out_error_dict = {
   ...
   my $check_out_input_validator_list = [
   ];
   my $check_out_output_validator_list = [];

   #
   # properties for check_in operation
   #
   my $check_in_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'template_library_item' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'CheckOuts::CheckInSpec')),
      }
   );
   my $check_in_error_dict = {
      'com.vmware.vapi.std.errors.invalid_argument' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'InvalidArgument'),
   ...
   my $check_in_input_validator_list = [
   ];
   my $check_in_output_validator_list = [];
   ...
   my $operations = {
      'check_out' => {
                ...
                'input_validator_list'=> $check_out_input_validator_list,
      ...
      'check_in' => {
                ...
                'input_validator_list'=> $check_in_input_validator_list,
                'output_validator_list'=> $check_in_output_validator_list,
            },
      'list' => {
                'input_type'=> $list_input_type,
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'CheckOuts::Summary')),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'CheckOuts::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm_template.library_items.check_outs',
