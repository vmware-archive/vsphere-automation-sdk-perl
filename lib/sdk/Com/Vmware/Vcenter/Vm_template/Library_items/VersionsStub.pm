...
package Com::Vmware::Vcenter::Vm_template::Library_items::VersionsStub;

## @class Com::Vmware::Vcenter::Vm_template::Library_items::Versions
#
#The {@name Versions} {@term service} provides {@term operations} for
#managing the live versions of the virtual machine templates contained in
#a library item. Live versions include the latest and previous virtual
#machine templates that are available on disk. As new versions of virtual
#machine templates are checked in, old versions of virtual machine templates
#are automatically purged. Currently, at most one previous virtual machine
...
sub new
{
   ...
   #
   my $rollback_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'template_library_item' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'version' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'Versions::RollbackSpec')),
      }
   );
   my $rollback_error_dict = {
      'com.vmware.vapi.std.errors.not_found' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'NotFound'),
      'com.vmware.vapi.std.errors.invalid_argument' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'InvalidArgument'),
   ...
   my $rollback_input_validator_list = [
   ];
   my $rollback_output_validator_list = [];
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'Versions::Summary')),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm_template::Library_items', 'type_name' => 'Versions::Info'),
      ...
      'rollback' => {
                ...
                'input_validator_list'=> $rollback_input_validator_list,
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm_template.library_items.versions',
