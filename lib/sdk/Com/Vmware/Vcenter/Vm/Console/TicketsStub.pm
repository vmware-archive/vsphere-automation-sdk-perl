...
package Com::Vmware::Vcenter::Vm::Console::TicketsStub;

## @class Com::Vmware::Vcenter::Vm::Console::Tickets
#
#The {@name Tickets} {@term service} provides {@term operations} for
#managing the virtual machine console tickets.
#
...
sub new
{
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Console', 'type_name' => 'Tickets::CreateSpec'),
      }
   );
   ...
   my $operations = {
      'create' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Console', 'type_name' => 'Tickets::Summary'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.console.tickets',
