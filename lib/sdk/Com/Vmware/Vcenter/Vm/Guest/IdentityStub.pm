...
package Com::Vmware::Vcenter::Vm::Guest::IdentityStub;

## @class Com::Vmware::Vcenter::Vm::Guest::Identity
#
#The {@name Identity} {@term service} provides {@term operations} for
#retrieving guest operating system identification information.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Guest', 'type_name' => 'Identity::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.guest.identity',
