...
package Com::Vmware::Vcenter::Vm::Guest::Networking::RoutesStub;

## @class Com::Vmware::Vcenter::Vm::Guest::Networking::Routes
#
#The {@name Routes} {@term service} provides {@term operations} for
#retrieving guest operating system network routing information.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Guest::Networking', 'type_name' => 'Routes::Info')),
