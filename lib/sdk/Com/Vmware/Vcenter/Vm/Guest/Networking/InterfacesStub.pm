...
package Com::Vmware::Vcenter::Vm::Guest::Networking::InterfacesStub;

## @class Com::Vmware::Vcenter::Vm::Guest::Networking::Interfaces
#
#The {@name Interfaces} {@term service} provides {@term operations} for
#retrieving guest operating system network interface information.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Guest::Networking', 'type_name' => 'Interfaces::Info')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.guest.networking.interfaces',
