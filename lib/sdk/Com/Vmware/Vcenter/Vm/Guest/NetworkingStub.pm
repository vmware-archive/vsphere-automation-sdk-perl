...
package Com::Vmware::Vcenter::Vm::Guest::NetworkingStub;

## @class Com::Vmware::Vcenter::Vm::Guest::Networking
#
#The {@name Networking} {@term service} provides {@term operations} for
#retrieving guest operating system network information.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Guest', 'type_name' => 'Networking::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.guest.networking',
