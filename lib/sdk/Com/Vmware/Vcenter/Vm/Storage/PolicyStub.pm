...
package Com::Vmware::Vcenter::Vm::Storage::PolicyStub;

## @class Com::Vmware::Vcenter::Vm::Storage::Policy
#
#The {@name Policy} {@term service} provides {@term operations} to
#configure the storage policies associated with the virtual machine home
...
sub new
{
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Storage', 'type_name' => 'Policy::UpdateSpec'),
      }
   );
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Storage', 'type_name' => 'Policy::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.storage.policy',
