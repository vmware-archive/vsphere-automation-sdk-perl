...
package Com::Vmware::Vcenter::Vm::Storage::Policy::ComplianceStub;

## @class Com::Vmware::Vcenter::Vm::Storage::Policy::Compliance
#
#The {@term Compliance} {@term service} provides {@term operations} that
#return the compliance status of virtual machine entities(virtual machine home
#directory and virtual disks) that specify storage policy requirements.
#
...
sub new
{
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'check_spec' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Storage::Policy', 'type_name' => 'Compliance::CheckSpec')),
      }
   );
   my $check_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Storage::Policy', 'type_name' => 'Compliance::Info')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.storage.policy.compliance',
