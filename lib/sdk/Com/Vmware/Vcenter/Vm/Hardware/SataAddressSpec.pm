...
#
#
# The  ``Com::Vmware::Vcenter::Vm::Hardware::SataAddressSpec``   *class*  contains
#     information for specifying the address of a virtual device that is attached to a
#     virtual SATA adapter of a virtual machine.

package Com::Vmware::Vcenter::Vm::Hardware::SataAddressSpec;
...
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Vm::Hardware::SataAddressSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.vm.hardware.sata_address_spec');
