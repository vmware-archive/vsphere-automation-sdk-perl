...
#
#
# The  ``Com::Vmware::Vcenter::Vm::Hardware::ConnectionUpdateSpec``   *class*  describes
#     the updates to be made to the configuration of a removable virtual device.

package Com::Vmware::Vcenter::Vm::Hardware::ConnectionUpdateSpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Vm::Hardware::ConnectionUpdateSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Vm::Hardware::ConnectionUpdateSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.vm.hardware.connection_update_spec');
