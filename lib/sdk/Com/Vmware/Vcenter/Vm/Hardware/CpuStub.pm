...
package Com::Vmware::Vcenter::Vm::Hardware::CpuStub;

## @class Com::Vmware::Vcenter::Vm::Hardware::Cpu
#
#The {@name Cpu} {@term service} provides {@term operations} for
#configuring the CPU settings of a virtual machine.
#
...
sub new
{
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Cpu::UpdateSpec'),
      }
   );
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Cpu::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.hardware.cpu',
