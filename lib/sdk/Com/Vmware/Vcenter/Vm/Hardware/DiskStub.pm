...
package Com::Vmware::Vcenter::Vm::Hardware::DiskStub;

## @class Com::Vmware::Vcenter::Vm::Hardware::Disk
#
#The {@name Disk} {@term service} provides {@term operations} for configuring
#the virtual disks of a virtual machine.  A virtual disk has a backing such
#as a VMDK file.  The backing has an independent lifecycle from the virtual
#machine when it is detached from the virtual machine.
#The {@link #create} {@term operation} provides the ability to create a new
#virtual disk.  When creating a virtual disk, a new VMDK file may be created
#or an existing VMDK file may used as a backing.  Once a VMDK file is
#associated with a virtual machine, its lifecycle will be bound to the
#virtual machine.  In other words, it will be deleted when the virtual
#machine is deleted.
#The {@link #delete} {@term operation} provides the ability to detach a
#VMDK file from the virtual machine.  The {@link #delete} {@term operation}
#does not delete the VMDK file that backs the virtual disk.  Once detached,
#the VMDK file will not be destroyed when the virtual machine to which it
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'disk' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $get_error_dict = {
      'com.vmware.vapi.std.errors.error' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Error'),
   ...
   my $create_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Disk::CreateSpec'),
      }
   );
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'vm' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'disk' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Disk::UpdateSpec'),
      }
   );
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Disk::Summary')),
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Vm::Hardware', 'type_name' => 'Disk::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.vm.hardware.disk',
