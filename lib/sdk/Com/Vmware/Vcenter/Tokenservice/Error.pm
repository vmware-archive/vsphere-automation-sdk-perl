## @class Com::Vmware::Vcenter::Tokenservice::Error
#
#
# The  ``Com::Vmware::Vcenter::Tokenservice::Error``   *error*  describes the *fields* 
...
#     localizable messages from  :attr:`Com::Vmware::Vcenter::Tokenservice::Error.messages` 
#     to a human. </li>
...
package Com::Vmware::Vcenter::Tokenservice::Error;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Tokenservice::Error structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Tokenservice::Error');
   $self->set_binding_name('name' => 'com.vmware.vcenter.tokenservice.error');
...
#     describe what, if any, data it provides for each  *error*  it reports. The null, null,
#     and null  *classes*  are intended as possible values for this  *field* .  class
#     Com::Vmware::Vapi::Std::DynamicID  may also be useful as a value for this  *field* 
#     (although that is not its primary purpose). Some  *interfaces*  may provide their own
#     specific  *classes*  for use as the value of this  *field*  when reporting  *errors* 
#     from their  *methods* .</p>
#
# Optional#
sub get_data {
   my ($self, %args) = @_;
