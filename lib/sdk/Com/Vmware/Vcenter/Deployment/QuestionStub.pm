...
package Com::Vmware::Vcenter::Deployment::QuestionStub;

## @class Com::Vmware::Vcenter::Deployment::Question
#
#The {@name Question} {@term service} provides {@term operations}
#to get the question raised during deployment and to answer them.
#
...
sub new
{
   ...
   #
   my $answer_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment', 'type_name' => 'Question::AnswerSpec'),
      }
   );
   my $answer_error_dict = {
      'com.vmware.vapi.std.errors.unauthenticated' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Std::Errors', 'type_name' => 'Unauthenticated'),
   ...
   my $answer_input_validator_list = [
   ];
   my $answer_output_validator_list = [];
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment', 'type_name' => 'Question::Info'),
