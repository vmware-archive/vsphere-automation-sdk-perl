## @class Com::Vmware::Vcenter::Deployment::Notification
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Deployment::Notification structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Deployment::Notification');
   $self->set_binding_name('name' => 'com.vmware.vcenter.deployment.notification');
