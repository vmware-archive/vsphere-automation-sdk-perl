## @class Com::Vmware::Vcenter::Deployment::StandalonePscSpec
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Deployment::StandalonePscSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Deployment::StandalonePscSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.deployment.standalone_psc_spec');
