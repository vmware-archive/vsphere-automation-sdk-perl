## @class Com::Vmware::Vcenter::Deployment::ReplicatedPscSpec
#
#
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Deployment::ReplicatedPscSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Deployment::ReplicatedPscSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.deployment.replicated_psc_spec');
