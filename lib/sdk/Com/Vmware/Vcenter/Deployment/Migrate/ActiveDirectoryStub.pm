...
package Com::Vmware::Vcenter::Deployment::Migrate::ActiveDirectoryStub;

## @class Com::Vmware::Vcenter::Deployment::Migrate::ActiveDirectory
#
#The {@name ActiveDirectory} {@term service} provides {@term operations}
#to check if the migrated vCenter Server appliance can join to the given
#domain using the provided credentials.
#
...
sub new
{
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment::Migrate', 'type_name' => 'ActiveDirectory::CheckSpec'),
      }
   );
   my $check_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment.migrate.active_directory',
