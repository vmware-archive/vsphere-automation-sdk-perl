...
package Com::Vmware::Vcenter::Deployment::Install::Psc::ReplicatedStub;

## @class Com::Vmware::Vcenter::Deployment::Install::Psc::Replicated
#
#The {@name Replicated} {@term service} provides {@term operations}
#to check if the configuring vCenter Server can be replicated to the
#remote PSC.
#
...
sub new
{
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment', 'type_name' => 'ReplicatedPscSpec'),
      }
   );
   my $check_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment.install.psc.replicated',
