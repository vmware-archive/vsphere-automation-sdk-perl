...
package Com::Vmware::Vcenter::Deployment::Install::Psc::StandaloneStub;

## @class Com::Vmware::Vcenter::Deployment::Install::Psc::Standalone
#
#The {@name Standalone} {@term service} provides {@term operations}
#to check if the values provided for the standalone PSC satisfies the
#requirements.
#
...
sub new
{
   ...
   my $check_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment', 'type_name' => 'StandalonePscSpec'),
      }
   );
   my $check_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment.install.psc.standalone',
