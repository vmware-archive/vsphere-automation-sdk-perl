...
package Com::Vmware::Vcenter::Deployment::Install::RemotePscStub;

## @class Com::Vmware::Vcenter::Deployment::Install::RemotePsc
#
#The {@name RemotePsc} {@term service} provides {@term operations}
#to check if the deployed vCenter Server can register with the remote PSC.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment.install.remote_psc',
