...
package Com::Vmware::Vcenter::Deployment::Install::Initial_config::Remote_psc::ThumbprintStub;

## @class Com::Vmware::Vcenter::Deployment::Install::Initial_config::Remote_psc::Thumbprint
#
#The {@name Thumbprint} {@term service} provides {@term operations}
#to get the thumbprint of the remote PSC.
#
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Deployment::Install::Initial_config::Remote_psc', 'type_name' => 'Thumbprint::RemoteSpec'),
      }
   );
   my $get_error_dict = {
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.deployment.install.initial_config.remote_psc.thumbprint',
