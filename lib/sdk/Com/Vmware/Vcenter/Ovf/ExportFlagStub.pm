...
package Com::Vmware::Vcenter::Ovf::ExportFlagStub;

## @class Com::Vmware::Vcenter::Ovf::ExportFlag
#
#The {@name ExportFlag} {@term service} provides {@term operations} for retrieving
#information about the export flags supported by the server. Export flags can be specified in a
#{@link LibraryItem.CreateSpec} to customize an OVF export.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Ovf', 'type_name' => 'ExportFlag::Info')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.ovf.export_flag',
