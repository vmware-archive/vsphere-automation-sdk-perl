...
package Com::Vmware::Vcenter::Ovf::ImportFlagStub;

## @class Com::Vmware::Vcenter::Ovf::ImportFlag
#
#The {@name ImportFlag} {@term service} provides {@term operations} for retrieving
#information about the import flags supported by the deployment platform. Import flags can be
#specified in a {@link LibraryItem.ResourcePoolDeploymentSpec} to customize an OVF deployment.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'rp' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Ovf', 'type_name' => 'ImportFlag::Info')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.ovf.import_flag',
