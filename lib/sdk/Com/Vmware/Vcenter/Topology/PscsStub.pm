...
package Com::Vmware::Vcenter::Topology::PscsStub;

## @class Com::Vmware::Vcenter::Topology::Pscs
#
#The {@name Pscs} {@term service} provides
#{@term operations} to decommission the external
...
sub new
{
   ...
   #
   my $decommission_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'hostname' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Topology', 'type_name' => 'Pscs::DecommissionSpec'),
                   'only_precheck' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::BooleanType()),
      }
   );
   my $decommission_error_dict = {
   ...
   my $decommission_input_validator_list = [
   ];
   my $decommission_output_validator_list = [];
   ...
   my $operations = {
      'decommission' => {
                ...
                'input_validator_list'=> $decommission_input_validator_list,
                'output_validator_list'=> $decommission_output_validator_list,
            },
   };
