...
package Com::Vmware::Vcenter::Topology::ReplicationStatusStub;

## @class Com::Vmware::Vcenter::Topology::ReplicationStatus
#
#The {@name ReplicationStatus} {@term interface} provides {@term operations}
#to retrieve replication status information of vCenter and Platform Services
#Controller nodes of type VCSA_EMBEDDED/PSC_EXTERNAL (see
#{@link Nodes.Info#type}).
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Topology', 'type_name' => 'ReplicationStatus::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Topology', 'type_name' => 'ReplicationStatus::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.topology.replication_status',
