...
package Com::Vmware::Vcenter::Namespace_management::HostsConfigStub;

## @class Com::Vmware::Vcenter::Namespace_management::HostsConfig
#
#The {@name Compatibility} {@term service} provides {@term operations} to
#retrieve information about vSphere Namespaces support and licensing.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'HostsConfig::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.hosts_config',
