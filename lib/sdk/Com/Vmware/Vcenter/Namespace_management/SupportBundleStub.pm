...
package Com::Vmware::Vcenter::Namespace_management::SupportBundleStub;

## @class Com::Vmware::Vcenter::Namespace_management::SupportBundle
#
#The {@name SupportBundle} {@term service} provides {@term
#operations} to retrieve the cluster's Namespaces-related support bundle
#download location.
#
...
sub new
{
   ...
   my $operations = {
      'create' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'SupportBundle::Location'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.support_bundle',
