...
## @file EdgeClusterCompatibilityStub.pm
...
package Com::Vmware::Vcenter::Namespace_management::EdgeClusterCompatibilityStub;

## @class Com::Vmware::Vcenter::Namespace_management::EdgeClusterCompatibility
#
#The {@name EdgeClusterCompatibility} {@term service} provides
#{@term operations} to get Namespaces compatibility information of NSX Edge
#Clusters.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'distributed_switch' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'EdgeClusterCompatibility::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'EdgeClusterCompatibility::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.edge_cluster_compatibility',
