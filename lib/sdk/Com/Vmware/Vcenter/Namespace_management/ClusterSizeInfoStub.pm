...
package Com::Vmware::Vcenter::Namespace_management::ClusterSizeInfoStub;

## @class Com::Vmware::Vcenter::Namespace_management::ClusterSizeInfo
#
#The {@name cluster-size-info} {@term service} provides {@term
#operations} to retrieve various sizes available for enabling Namespaces and
#information about each size.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'SizingHint'), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'ClusterSizeInfo::Info')}))),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.cluster_size_info',
