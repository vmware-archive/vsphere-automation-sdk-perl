...
## @file DistributedSwitchCompatibilityStub.pm
...
package Com::Vmware::Vcenter::Namespace_management::DistributedSwitchCompatibilityStub;

## @class Com::Vmware::Vcenter::Namespace_management::DistributedSwitchCompatibility
#
#The {@name DistributedSwitchCompatibility} {@term service} provides
#{@term operations} to get Namespaces compatibility information of Distributed
#Switches in this vCenter.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   ...
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'DistributedSwitchCompatibility::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'DistributedSwitchCompatibility::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.distributed_switch_compatibility',
