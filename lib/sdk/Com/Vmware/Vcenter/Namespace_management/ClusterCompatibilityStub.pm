...
## @file ClusterCompatibilityStub.pm
...
package Com::Vmware::Vcenter::Namespace_management::ClusterCompatibilityStub;

## @class Com::Vmware::Vcenter::Namespace_management::ClusterCompatibility
#
#The {@name ClusterCompatibility} {@term service} provides
#{@term operations} to get Namespace-related compatibility information for
#clusters in this vCenter.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'ClusterCompatibility::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'ClusterCompatibility::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.cluster_compatibility',
