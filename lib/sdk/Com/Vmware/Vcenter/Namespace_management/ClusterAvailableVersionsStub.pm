...
## @file ClusterAvailableVersionsStub.pm
...
package Com::Vmware::Vcenter::Namespace_management::ClusterAvailableVersionsStub;

## @class Com::Vmware::Vcenter::Namespace_management::ClusterAvailableVersions
#
#The {@name cluster-available-versions} {@term service} provides {@term
#operations} to retrieve available upgrade versions of WCP and detailed
#information about each upgrade.
#
...
sub new
{
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'ClusterAvailableVersions::Summary')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.cluster_available_versions',
