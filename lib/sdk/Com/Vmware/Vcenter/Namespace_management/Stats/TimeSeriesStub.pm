...
package Com::Vmware::Vcenter::Namespace_management::Stats::TimeSeriesStub;

## @class Com::Vmware::Vcenter::Namespace_management::Stats::TimeSeries
#
#The {@name TimeSeries} {@term service} provides {@term operations}
#to gather statistical values for clusters, namespaces and pods.
#
...
sub new
{
   ...
   my $get_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management::Stats', 'type_name' => 'TimeSeries::Spec'),
      }
   );
   my $get_error_dict = {
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management::Stats', 'type_name' => 'TimeSeries::TimeSeries')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.stats.time_series',
