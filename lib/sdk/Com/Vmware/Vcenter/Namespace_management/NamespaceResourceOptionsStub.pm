...
## @file NamespaceResourceOptionsStub.pm
...
package Com::Vmware::Vcenter::Namespace_management::NamespaceResourceOptionsStub;

## @class Com::Vmware::Vcenter::Namespace_management::NamespaceResourceOptions
#
#The {@name NamespaceResourceOptions} {@term service} provides {@term
#operations} to get the objects used to create and modify resource quotas on
#a namespace.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Namespace_management', 'type_name' => 'NamespaceResourceOptions::Info'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.namespace_management.namespace_resource_options',
