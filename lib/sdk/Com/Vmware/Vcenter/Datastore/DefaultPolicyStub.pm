...
package Com::Vmware::Vcenter::Datastore::DefaultPolicyStub;

## @class Com::Vmware::Vcenter::Datastore::DefaultPolicy
#
#The {@name DefaultPolicy} {@term service} provides {@term operations} related
#to storage policies associated with datastore object.
#The {@link #get} {@term operation} provides information about the default
#storage policy associated with the specific datastore.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::StringType()),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.datastore.default_policy',
