...
package Com::Vmware::Vcenter::System_config::DeploymentTypeStub;

## @class Com::Vmware::Vcenter::System_config::DeploymentType
#
#The {@name DeploymentType} {@term service} provides
#{@term operations} to get/set the type of the appliance.
#
...
sub new
{
   ...
   #
   my $reconfigure_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'spec' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::System_config', 'type_name' => 'DeploymentType::ReconfigureSpec'),
      }
   );
   my $reconfigure_error_dict = {
   ...
   my $reconfigure_input_validator_list = [
   ];
   my $reconfigure_output_validator_list = [];
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::System_config', 'type_name' => 'DeploymentType::Info'),
      ...
      'reconfigure' => {
                ...
                'input_validator_list'=> $reconfigure_input_validator_list,
                'output_validator_list'=> $reconfigure_output_validator_list,
            },
   };

   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.system_config.deployment_type',
