...
package Com::Vmware::Vcenter::Storage::Policies::ComplianceStub;

## @class Com::Vmware::Vcenter::Storage::Policies::Compliance
#
#The {@term Compliance} {@term service} provides {@term operations}
#related to all the associated entities of given compliance statuses.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage::Policies', 'type_name' => 'Compliance::FilterSpec'),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage::Policies', 'type_name' => 'Compliance::Summary')),
