...
package Com::Vmware::Vcenter::Storage::Policies::VMStub;

## @class Com::Vmware::Vcenter::Storage::Policies::VM
#
#The {@name VM} {@term service} provides {@term operations}
#managing the storage policy association for a virtual machine and
#its virtual disks.
#
...
sub new
{
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.vcenter.storage.policies.VM',
