...
package Com::Vmware::Vcenter::Storage::Policies::Compliance::VMStub;

## @class Com::Vmware::Vcenter::Storage::Policies::Compliance::VM
#
#The {@name VM} {@term structure} provides {@term operations}
#related to query virtual machines of given compliance statuses.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage::Policies::Compliance', 'type_name' => 'VM::FilterSpec'),
      }
   );
   my $list_error_dict = {
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::MapType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StructType('name' => 'map-entry', 'fields' => {'key' => new Com::Vmware::Vapi::Bindings::Type::StringType(), 'value' =>  new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage::Policies::Compliance', 'type_name' => 'VM::Info')}))),
