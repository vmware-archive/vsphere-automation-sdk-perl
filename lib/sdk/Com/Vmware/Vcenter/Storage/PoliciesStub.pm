...
package Com::Vmware::Vcenter::Storage::PoliciesStub;

## @class Com::Vmware::Vcenter::Storage::Policies
#
#The {@name Policies} {@term service} provides {@term operations} for
#managing the storage policies.
#
...
sub new
{
   ...
   my $list_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'filter' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage', 'type_name' => 'Policies::FilterSpec')),
      }
   );
   my $list_error_dict = {
   ...
   #
   my $check_compatibility_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      'name' => 'operation-input',
      'fields' => {
                   'policy' => new Com::Vmware::Vapi::Bindings::Type::StringType(),
                   'datastores' => new Com::Vmware::Vapi::Bindings::Type::SetType('binding_type' => new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::StringType())),
      }
   );
   my $check_compatibility_error_dict = {
   ...
   my $check_compatibility_input_validator_list = [
   ];
   my $check_compatibility_output_validator_list = [];
   ...
   my $operations = {
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage', 'type_name' => 'Policies::Summary')),
      ...
      'check_compatibility' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vcenter::Storage', 'type_name' => 'Policies::CompatibilityInfo'),
                'errors'=> $check_compatibility_error_dict,
                'input_validator_list'=> $check_compatibility_input_validator_list,
