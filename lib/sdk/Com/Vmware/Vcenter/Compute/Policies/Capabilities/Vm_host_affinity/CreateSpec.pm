## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec``
#     *class*  contains information used to create a new virtual machine to host affinity
#     policy, see  :func:`Com::Vmware::Vcenter::Compute::Policies.create` . Virtual machines
#     that have the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec.vm_tag`
#     will be affine to hosts that have the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec.host_tag`
#     . <b>Warning:</b> This  *class*  is available as technical preview. It may be changed
#     in a future release.

package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.vm_host_affinity.create_spec');
...
#     with this tag will be affine to the hosts indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec.host_tag`
#     . <b>Warning:</b> This  *field*  is available as technical preview. It may be changed
#     in a future release.
#
# ID#
sub get_vm_tag {
...
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::CreateSpec.vm_tag`
#     will be affine to hosts with this tag. <b>Warning:</b> This  *field*  is available as
