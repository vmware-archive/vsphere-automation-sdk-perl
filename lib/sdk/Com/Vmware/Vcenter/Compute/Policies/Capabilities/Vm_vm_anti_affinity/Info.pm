## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info``  
#     *class*  contains information about a VM-VM anti-affinity policy, see 
#     :func:`Com::Vmware::Vcenter::Compute::Policies.get` . All virtual machines that share
#     the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info.vm_tag`
#     are anti-affine to each other in VMware Cloud on AWS. Usage beyond VMware Cloud on AWS
...
package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.info');
...
#     with this tag are anti-affine to each other. <b>Warning:</b> This  *field*  is
