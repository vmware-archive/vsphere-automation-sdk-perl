## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info``
#     *class*  contains information about a policy to ignore virtual machine capabilities
#     when scaling-in a cluster, see  :func:`Com::Vmware::Vcenter::Compute::Policies.get` .
#     When considering scaling-in a cluster, policies that have been created with one of the
#     listed 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info.vm_capabilities`
#     are ignored for virtual machines that have the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info.vm_tag`
...
package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Cluster_scale_in_ignore_vm_capabilities::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.cluster_scale_in_ignore_vm_capabilities.info');
