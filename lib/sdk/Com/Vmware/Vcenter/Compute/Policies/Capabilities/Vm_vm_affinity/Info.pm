...
#     are affined to each other in VMware Cloud on AWS. Usage beyond VMware Cloud on AWS is
#     not supported. <b>Warning:</b> This  *class*  is available as Technology Preview.
