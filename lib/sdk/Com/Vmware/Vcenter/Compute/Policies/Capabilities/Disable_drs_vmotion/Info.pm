## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Disable_drs_vmotion::Info
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Disable_drs_vmotion::Info``  
#     *class*  contains information about a DisableDrsVmotion policy, see 
#     :func:`Com::Vmware::Vcenter::Compute::Policies.get`  in VMware Cloud on AWS. Usage
#     beyond VMware Cloud on AWS is not supported. <b>Warning:</b> This  *class*  is
...
package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Disable_drs_vmotion::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Disable_drs_vmotion::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Disable_drs_vmotion::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.disable_drs_vmotion.info');
