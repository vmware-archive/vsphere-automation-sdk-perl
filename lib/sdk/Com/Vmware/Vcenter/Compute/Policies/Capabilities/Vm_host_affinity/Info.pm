## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info
#
#
# The  ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info``
#     *class*  contains information about a virtual machine to host affinity policy, see 
#     :func:`Com::Vmware::Vcenter::Compute::Policies.get` . Virtual machines that have the
#     tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info.vm_tag`
#     will be affine to hosts that have the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info.host_tag`
#     . <b>Warning:</b> This  *class*  is available as technical preview. It may be changed
#     in a future release.

package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_host_affinity::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.vm_host_affinity.info');
