## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_affinity::CreateSpec
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_affinity::CreateSpec`` 
#     *class*  contains information used to create a new VM-VM affinity policy, see 
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_affinity::CreateSpec structure
#
# @retval
# Blessed object
#
