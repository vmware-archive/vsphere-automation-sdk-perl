## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec``
#     *class*  contains information used to create a new VM-VM anti-affinity policy, see 
#     :func:`Com::Vmware::Vcenter::Compute::Policies.create` . All virtual machines that
#     share the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec.vm_tag`
#     will be anti-affine to each other in VMware Cloud on AWS. Usage beyond VMware Cloud on
#     AWS is not supported. <b>Warning:</b> This  *class*  is available as Technology
...
package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm_vm_anti_affinity::CreateSpec');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.create_spec');
...
#     with this tag will be anti-affine to each other. <b>Warning:</b> This  *field*  is
