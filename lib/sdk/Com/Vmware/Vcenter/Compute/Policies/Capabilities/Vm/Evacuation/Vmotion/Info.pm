## @class Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info
#
#
# The 
#     ``Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info``
#     *class*  contains information about a vMotion policy that applies when a host is
#     evacuated, see  :func:`Com::Vmware::Vcenter::Compute::Policies.get` , in VMware Cloud
#     on AWS. Usage beyond VMware Cloud on AWS is not supported. All virtual machines that
#     share the tag indicated by 
#     :attr:`Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info.vm_tag`
...
package Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vcenter::Compute::Policies::Capabilities::Vm::Evacuation::Vmotion::Info');
   $self->set_binding_name('name' => 'com.vmware.vcenter.compute.policies.capabilities.vm.evacuation.vmotion.info');
