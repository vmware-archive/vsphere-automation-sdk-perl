...
# The  ``Com::Vmware::Vapi::Metadata::Metamodel::Source``   *interface*  provides 
#     *methods*  to manage the sources of metamodel metadata information. <p>
# 
...
#     properties files. One of the generated files contains metamodel information. The
#     generated file can be registered as a source of metadata. </p>
# 
# <p>
# 
# The metamodel file contains all the data present in the interface definition files.
#     Each metamodel file contains data about one component element. When a metamodel file
#     is added as a source, each source contributes only one component element&apos;s
#     metadata. </p>
# 
# <p>
# 
# Metamodel metadata can also be discovered from a remote server that supports the
#     metamodel metadata  *interfaces*  (see  :mod:`com.vmware.vapi.metadata.metamodel` ).
...
package Com::Vmware::Vapi::Metadata::Metamodel::Source;
...
use Com::Vmware::Vapi::Metadata::Metamodel::SourceStub;
...
# the metadata source, the metamodel metadata is retrieved from the source. This populates
# elements in all the  *interfaces*  defined in  :mod:`com.vmware.vapi.metadata.metamodel`  
# *package* .
#
# @param source_id [REQUIRED] metadata source identifier.
# The value must be an identifier for the resource type
#     getQualifiedName(com.vmware.vapi.metadata.metamodel.source).
# . The value must be str.
#
# @param spec [REQUIRED] create specification.
# . The value must be Com::Vmware::Vapi::Metadata::Metamodel::Source::CreateSpec.
#
...
#     metamodel metadata in the JSON file is invalid.
# @throw Com::Vmware::Vapi::Std::Errors::InvalidArgument 
...
#     not have  *interfaces*  present in  :mod:`com.vmware.vapi.metadata.metamodel`  
#     *package* .
#
...
#
# @retval 
# The  class Com::Vmware::Vapi::Metadata::Metamodel::Source::Info  instance that
#     corresponds to  ``source_id`` 
# The return type will be Com::Vmware::Vapi::Metadata::Metamodel::Source::Info
#
# @throw Com::Vmware::Vapi::Std::Errors::NotFound 
# if the metadata source associated with  ``source_id``  is not found.
#
...
## @method reload ()
# Reloads the metamodel metadata from all the metadata sources or of a particular metadata
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Vapi::Metadata::Metamodel::Source service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Vapi::Metadata::Metamodel::Source service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Vapi::Metadata::Metamodel::Source service
#########################################################################################

## @class Com::Vmware::Vapi::Metadata::Metamodel::Source::Info
#
#
# The  ``Com::Vmware::Vapi::Metadata::Metamodel::Source::Info``   *class*  contains the
#     metadata source information.

package Com::Vmware::Vapi::Metadata::Metamodel::Source::Info;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vapi::Metadata::Metamodel::Source::Info structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vapi::Metadata::Metamodel::Source::Info');
   $self->set_binding_name('name' => 'com.vmware.vapi.metadata.metamodel.source.info');
...
#     :mod:`com.vmware.vapi.metadata.metamodel`   *package* . It must expose metamodel
...
## @class Com::Vmware::Vapi::Metadata::Metamodel::Source::CreateSpec
#
#
# The  ``Com::Vmware::Vapi::Metadata::Metamodel::Source::CreateSpec``   *class* 
#     contains the registration information of a metamodel source.

package Com::Vmware::Vapi::Metadata::Metamodel::Source::CreateSpec;
...
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vapi::Metadata::Metamodel::Source::CreateSpec');
   $self->set_binding_name('name' => 'com.vmware.vapi.metadata.metamodel.source.create_spec');
   $self->set_binding_field('key' => 'description', 'value' => new Com::Vmware::Vapi::Bindings::Type::StringType());
   $self->set_binding_field('key' => 'type', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Metadata', 'type_name' => 'SourceType'));
   $self->set_binding_field('key' => 'filepath', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::StringType()));
   $self->set_binding_field('key' => 'address', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::URIType()));
...
#########################################################################################
# Ends structures for the Com::Vmware::Vapi::Metadata::Metamodel::Source service
#########################################################################################
