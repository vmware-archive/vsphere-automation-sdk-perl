...
package Com::Vmware::Vapi::Metadata::Privilege::PackageStub;
...
sub new
{
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Metadata::Privilege', 'type_name' => 'PackageInfo'),
