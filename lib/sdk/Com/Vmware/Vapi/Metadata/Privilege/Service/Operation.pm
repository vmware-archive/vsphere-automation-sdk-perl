...
#use Com::Vmware::Vapi::Metadata::Privilege;

## @class Com::Vmware::Vapi::Metadata::Privilege::Service::Operation
# The  ``Com::Vmware::Vapi::Metadata::Privilege::Service::Operation``   *interface* 
#     provides  *methods*  to retrieve privilege information of an operation element. <p>
# 
# An operation element is said to contain privilege information if there are any
#     privileges assigned to the operation element or if one of the parameter elements
#     contained in it has privileges assigned in privilege definition file.</p>
#
#
# Constant String::RESOURCE_TYPE #
#Resource type for operation.

package Com::Vmware::Vapi::Metadata::Privilege::Service::Operation;
...
use Com::Vmware::Vapi::Metadata::Privilege::Service::OperationStub;
...
# corresponding to  ``service_id``  that have privilege information.
#
...
#
# @retval 
# The  class Com::Vmware::Vapi::Metadata::Privilege::OperationInfo  instance that
#     corresponds to  ``operation_id`` .
# The return type will be Com::Vmware::Vapi::Metadata::Privilege::OperationInfo
#
# @throw Com::Vmware::Vapi::Std::Errors::NotFound 
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Vapi::Metadata::Privilege::Service::Operation service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Vapi::Metadata::Privilege::Service::Operation service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Vapi::Metadata::Privilege::Service::Operation service
#########################################################################################


#########################################################################################
# Ends structures for the Com::Vmware::Vapi::Metadata::Privilege::Service::Operation service
#########################################################################################
