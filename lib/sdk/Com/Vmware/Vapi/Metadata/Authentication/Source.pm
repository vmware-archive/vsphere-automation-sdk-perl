...
# The  ``Com::Vmware::Vapi::Metadata::Authentication::Source``   *interface*  provides 
#     *methods*  to manage the sources of authentication metadata information. <p>
# 
...
#     properties files. One of the generated files contains authentication information. The
#     generated file can be registered as a source of metadata. </p>
# 
# <p>
# 
# The authentication file contains all the data present in the interface definition
#     files. Each authentication file contains data about one component element. When a
#     authentication file is added as a source, each source contributes only one component
#     element&apos;s metadata. </p>
# 
# <p>
# 
# Authentication metadata can also be discovered from a remote server that supports the
#     authentication metadata  *interfaces*  (see 
#     :mod:`com.vmware.vapi.metadata.authentication` ). Since multiple components can be
#     registered with a single metadata server, when a remote server is registered as a
#     source, that source can contribute more than one component.</p>
#
#
# Constant String::RESOURCE_TYPE #
#Resource type for metadata source.

package Com::Vmware::Vapi::Metadata::Authentication::Source;
...
use Com::Vmware::Vapi::Metadata::Authentication::SourceStub;
...
# the metadata source, the authentication metadata is retrieved from the source. This
# populates elements in all the  *interfaces*  defined in 
# :mod:`com.vmware.vapi.metadata.authentication`   *package* .
#
# @param source_id [REQUIRED] metadata source identifier.
# The value must be an identifier for the resource type
#     getQualifiedName(com.vmware.vapi.metadata.authentication.source).
# . The value must be str.
#
# @param spec [REQUIRED] create specification.
# . The value must be Com::Vmware::Vapi::Metadata::Authentication::Source::CreateSpec.
#
...
#     authentication metadata in the JSON file is invalid.
# @throw Com::Vmware::Vapi::Std::Errors::InvalidArgument 
...
#     not have  *interfaces*  present in  :mod:`com.vmware.vapi.metadata.authentication`  
#     *package* .
#
...
#
# @retval 
# The  class Com::Vmware::Vapi::Metadata::Authentication::Source::Info  instance that
#     corresponds to  ``source_id`` 
# The return type will be Com::Vmware::Vapi::Metadata::Authentication::Source::Info
#
# @throw Com::Vmware::Vapi::Std::Errors::NotFound 
...
## @method reload ()
# Reloads the authentication metadata from all the metadata sources or of a particular
# metadata source if  ``source_id``  is specified.
#
...
#########################################################################################
# Begins enumerations for the Com::Vmware::Vapi::Metadata::Authentication::Source service
#########################################################################################



#########################################################################################
# Ends enumerations for the Com::Vmware::Vapi::Metadata::Authentication::Source service
#########################################################################################

#########################################################################################
# Begins structures for the Com::Vmware::Vapi::Metadata::Authentication::Source service
#########################################################################################

## @class Com::Vmware::Vapi::Metadata::Authentication::Source::Info
#
#
# The  ``Com::Vmware::Vapi::Metadata::Authentication::Source::Info``   *class*  contains
#     the metadata source information.

package Com::Vmware::Vapi::Metadata::Authentication::Source::Info;
...
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vapi::Metadata::Authentication::Source::Info');
   $self->set_binding_name('name' => 'com.vmware.vapi.metadata.authentication.source.info');
...
# Absolute file path of the authentication metadata file that has the authentication
#     information about one component element. The  ``filePath``  is the path to the file in
...
#     :mod:`com.vmware.vapi.metadata.authentication`   *package* . It must expose
#     authentication information of one or more components.</p>
#
# optional#
sub get_address {
   my ($self, %args) = @_;
...
#
#
# The  ``Com::Vmware::Vapi::Metadata::Authentication::Source::CreateSpec``   *class* 
#     contains the registration information of a authentication source.

package Com::Vmware::Vapi::Metadata::Authentication::Source::CreateSpec;
...
## @method new ()
# Constructor to initialize the Com::Vmware::Vapi::Metadata::Authentication::Source::CreateSpec structure
#
# @retval
# Blessed object
#
sub new {
   ...
   $self->set_binding_class('binding_class' => 'Com::Vmware::Vapi::Metadata::Authentication::Source::CreateSpec');
   $self->set_binding_name('name' => 'com.vmware.vapi.metadata.authentication.source.create_spec');
   $self->set_binding_field('key' => 'description', 'value' => new Com::Vmware::Vapi::Bindings::Type::StringType());
   $self->set_binding_field('key' => 'type', 'value' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Vapi::Metadata', 'type_name' => 'SourceType'));
   $self->set_binding_field('key' => 'filepath', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::StringType()));
   $self->set_binding_field('key' => 'address', 'value' => new Com::Vmware::Vapi::Bindings::Type::OptionalType('element_type' => new Com::Vmware::Vapi::Bindings::Type::URIType()));
...
#########################################################################################
# Ends structures for the Com::Vmware::Vapi::Metadata::Authentication::Source service
#########################################################################################
