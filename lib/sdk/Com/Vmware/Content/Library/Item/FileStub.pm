...
package Com::Vmware::Content::Library::Item::FileStub;

## @class Com::Vmware::Content::Library::Item::File
#
#The {@name File} {@term service} can be used to query for information
#on the files within a library item. Files are objects which are added to a
#library item through the {@link UpdateSession} and
#{@link com.vmware.content.library.item.updatesession.File} {@term services}.
#
...
sub new
{
   ...
   my $operations = {
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Content::Library::Item', 'type_name' => 'File::Info'),
      ...
      'list' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ListType(new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Content::Library::Item', 'type_name' => 'File::Info')),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.content.library.item.file',
