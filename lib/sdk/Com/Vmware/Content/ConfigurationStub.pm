...
package Com::Vmware::Content::ConfigurationStub;

## @class Com::Vmware::Content::Configuration
#
#The {@name Configuration} {@term service} provides {@term operations} to
#configure the global settings of the Content Library Service.
#<p>
#The configuration settings are used by the Content Library Service to control
#the behavior of various operations.
#
...
sub new
{
   ...
   my $update_input_type = new Com::Vmware::Vapi::Bindings::Type::StructType(
      ...
      'fields' => {
                   'model' => new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Content', 'type_name' => 'ConfigurationModel'),
      }
   );
   ...
   my $operations = {
      ...
      'get' => {
                ...
                'output_type'=> new Com::Vmware::Vapi::Bindings::Type::ReferenceType('module_ctx' => 'Com::Vmware::Content', 'type_name' => 'ConfigurationModel'),
   ...
   my $self = $class->SUPER::new ('api_provider' => $api_provider,
                                  'iface_name' => 'com.vmware.content.configuration',
